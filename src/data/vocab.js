  ...
  book_08: [
    {
      ...
      pos: 'verb (past tense of scowl)',
      detail:
        'scowl 指因生气或不悦而皱起眉头、拉下脸来。本书中出现两次：第一次是金角大王对悟空怒目而视（Golden Horn scowled at Wukong）；第二次是唐僧对悟空皱眉表示不满（The Tang Monk scowled at the monkey），两次都表现了强烈的不满情绪。',
      examples: [
        'She scowled at the rude customer.（她对那个无礼的顾客怒目而视。）',
        'He scowled when he heard the bad news.（他听到坏消息时皱起了眉头。）',
      ],
      synonyms: [
        { word: 'frown', note: '皱眉，可因困惑或不悦，程度较轻' },
        { word: 'glare', note: '怒视，带有更强烈的敌意' },
      ],
    },
    {
      word: 'doubt',
      ...
      pos: 'verb',
      detail:
        'doubt 表示对某事的真实性或可能性感到不确定、不相信。原文中金角大王说 I doubt you have a gourd like mine，表示他不相信悟空拥有类似的宝葫芦。注意 doubt 中字母 b 不发音。',
      examples: [
        'I doubt he will come on time.（我怀疑他不会准时来。）',
        'Nobody doubted her ability.（没有人怀疑她的能力。）',
      ],
      synonyms: [
        { word: 'suspect', note: '怀疑（偏向认为某事是真的）' },
        { word: 'question', note: '质疑，提出疑问' },
      ],
    },
    {
      word: 'several',
      ...
      pos: 'determiner / pronoun',
      detail:
        'several 表示几个、数个，通常指三个以上但不超过很多。原文中 Several demons were inside 描述洞穴里有一些小妖，数量不多但足以造成威胁。',
      examples: [
        'I have several questions to ask.（我有几个问题想问。）',
        'Several students were late today.（今天有几个学生迟到了。）',
      ],
      synonyms: [
        { word: 'a few', note: '少数几个，语气更少' },
      ],
    },
    {
      word: 'shrugged',
      phonetic: '/ʃrʌɡd/',
      brief: '耸肩（表示不在乎、无奈或不知道）',
      pos: 'verb (past tense of shrug)',
      detail:
        'shrug 指上下耸动肩膀，是英语中常见的肢体语言，表示无所谓或我不知道的态度。原文中悟空对八戒的抱怨耸耸肩，表现出漫不经心的态度。',
      examples: [
        'She shrugged and said she did not know.（她耸了耸肩说不知道。）',
        'He shrugged off the criticism.（他对批评满不在乎。）',
      ],
      synonyms: [
        { word: 'dismiss', note: '不予理会，更正式' },
      ],
    },
    {
      word: 'boomed',
      ...
      pos: 'verb (past tense of boom)',
      detail:
        'boom 作动词指发出低沉而响亮的声音，常用来描述人说话时声音浑厚有力、带有威严。原文中老子用洪亮的声音命令悟空归还葫芦，体现了他作为天神的威势。',
      examples: [
        'Silence! boomed the principal.（安静！校长用洪亮的声音说道。）',
        'Thunder boomed in the distance.（远处传来隆隆雷声。）',
      ],
      synonyms: [
        { word: 'roared', note: '咆哮，声音更猛烈' },
        { word: 'bellowed', note: '大声吼叫，带有愤怒色彩' },
      ],
    },
    {
      word: 'joking around',
      phonetic: '/ˈdʒoʊkɪŋ əˈraʊnd/',
      brief: '开玩笑，闹着玩',
      pos: 'phrase',
      detail:
        'joke around 是一个非正式短语，意为开玩笑、闹着玩。原文中悟空对老子说 I was just joking around，意思是自己只是开个玩笑，并非真的想耍赖不还葫芦。',
      examples: [
        'Do not be mad, I am just joking around.（别生气，我只是在开玩笑。）',
        'The kids were joking around after class.（孩子们下课后在闹着玩。）',
      ],
      synonyms: [
        { word: 'kidding', note: '开玩笑，更简短口语化' },
        { word: 'messing around', note: '胡闹、瞎搞，语气更随便' },
      ],
    },
    {
      word: 'glanced',
      ...
      pos: 'verb (past tense of glance)',
      detail:
        'glance 指快速地看一眼，通常不是仔细观察。原文中悟空随意地看了一眼葫芦（glanced at the gourd），暗示他并不太担心金角大王的情况。',
      examples: [
        'She glanced at her watch.（她瞥了一眼手表。）',
        'He glanced up from his book.（他从书本上抬起头匆匆看了一眼。）',
      ],
      synonyms: [
        { word: 'peeked', note: '偷看，偷偷地看一眼' },
        { word: 'stared', note: '盯着看（反义词，目光长久而专注）' },
      ],
    },
    {
      word: 'moaning',
      phonetic: '/ˈmoʊnɪŋ/',
      brief: '呻吟声，呜咽声',
      pos: 'verb / adjective (present participle of moan)',
      detail:
        'moan 指低沉的呻吟声或哀号声，通常表示痛苦或悲伤。原文中唐僧在寺院里听到外面传来 a moaning sound，以为是鬼魂逼近，营造出恐怖的气氛。',
      examples: [
        'The patient was moaning in pain.（病人在痛苦地呻吟。）',
        'I heard a moaning wind outside.（我听到外面风声呜咽。）',
      ],
      synonyms: [
        { word: 'groaning', note: '呻吟，声音更低沉' },
        { word: 'whimpering', note: '抽泣声，带有恐惧或委屈' },
      ],
    },
    {
      word: 'trembling',
      phonetic: '/ˈtremblɪŋ/',
      brief: '发抖，颤抖',
      pos: 'verb (present participle of tremble)',
      detail:
        'tremble 指因恐惧、寒冷或激动而身体不由自主地抖动。原文中唐僧听到诡异的声音后 sat up, trembling with fear，trembling with fear 是固定搭配，意为吓得发抖。',
      examples: [
        'Her hands were trembling with cold.（她的手冻得发抖。）',
        'He was trembling with anger.（他气得浑身发抖。）',
      ],
      synonyms: [
        { word: 'shivering', note: '发抖，多因寒冷引起' },
        { word: 'shaking', note: '摇晃、发抖，泛指各种抖动' },
      ],
    },
    {
      word: 'creaked',
      phonetic: '/kriːkt/',
      brief: '嘎吱作响',
      pos: 'verb (past tense of creak)',
      detail:
        'creak 指门、地板、楼梯等因老化或受力而发出的嘎吱声。原文中 his door creaked open 描写了门慢慢被推开时发出的令人不安的声音，增添了鬼故事的悬疑氛围。',
      examples: [
        'The old stairs creaked under his weight.（老旧的楼梯在他脚下嘎吱作响。）',
        'The door creaked open slowly.（门慢慢嘎吱一声打开了。）',
      ],
      synonyms: [
        { word: 'squeaked', note: '发出尖细的吱嘎声' },
        { word: 'groaned', note: '发出低沉的呻吟声（如木板承重时）' },
      ],
    },
    {
      word: 'dripping',
      phonetic: '/ˈdrɪpɪŋ/',
      brief: '湿淋淋的，滴着水的',
      pos: 'adjective / verb (present participle of drip)',
      detail:
        'dripping wet 是固定搭配，意为湿淋淋的、浑身滴水。原文中鬼魂国王出现时 dripping wet，因为他从井里出来全身湿透，既符合逻辑又增强了恐怖效果。',
      examples: [
        'She came in dripping wet from the rain.（她淋着雨进来浑身湿透。）',
        'Water was dripping from the ceiling.（水从天花板滴下来。）',
      ],
      synonyms: [
        { word: 'soaking', note: '湿透的，强调完全被浸湿' },
        { word: 'sopping', note: '湿透的，更口语化' },
      ],
    },
    {
      word: 'suffered',
      phonetic: '/ˈsʌfərd/',
      brief: '遭受，经历（痛苦或困难）',
      pos: 'verb (past tense of suffer)',
      detail:
        'suffer 指经历痛苦、困难或损失。原文中乌鸡国国王讲述国家 suffered a horrible drought（遭受了可怕的旱灾），suffer 后常接表示灾难的名词。',
      examples: [
        'The city suffered a major earthquake.（这座城市遭受了一次大地震。）',
        'She suffered from headaches for years.（她头痛了很多年。）',
      ],
      synonyms: [
        { word: 'endured', note: '忍受，强调坚持忍耐' },
        { word: 'experienced', note: '经历，中性词不含痛苦意味' },
      ],
    },
    {
      word: 'drought',
      ...
      pos: 'noun',
      detail:
        'drought 指长期无雨造成的干旱状态。注意 drought 的拼写中 gh 不发音，发音为 /draʊt/。原文中乌鸡国遭遇五年前的严重旱灾，庄稼无法生长，百姓挨饿。',
      examples: [
        'The region is suffering from a severe drought.（该地区正遭受严重干旱。）',
        'Drought conditions have destroyed the harvest.（旱灾毁掉了收成。）',
      ],
      synonyms: [
    ...
    },
    {
      ...
      phonetic: '/krɑːps/',
      brief: '庄稼，农作物',
      pos: 'noun (plural of crop)',
      detail:
        'crop 指种植的农作物，crops 是复数形式。原文中旱灾导致庄稼无法生长（Crops would not grow），后来道士求雨后庄稼又开始生长（our crops began to grow）。',
      examples: [
        'The farmers are harvesting their crops.（农民们正在收割庄稼。）',
        'The flood destroyed all the crops.（洪水毁坏了所有庄稼。）',
      ],
      synonyms: [
        { word: 'harvest', note: '收成、收获，侧重收获的结果' },
        { word: 'produce', note: '农产品，泛指所有农业产出' },
      ],
    },
    {
      word: 'pray',
      ...
      pos: 'verb',
      detail:
        'pray 指向神灵或上天祈求、祷告。原文中道士声称他能 pray for rain（祈雨），这是中国古代常见的宗教仪式。pray for 表示为某事祈祷。',
      examples: [
        'She prayed for her family safety.（她为家人的平安祈祷。）',
        'They prayed that the rain would come.（他们祈祷降雨。）',
      ],
      synonyms: [
        { word: 'worship', note: '崇拜、敬奉，更侧重仪式本身' },
      ],
    },
    {
      word: 'prayers',
      ...
      detail:
        'prayer 是 pray 的名词形式，prayers 为复数。原文中唐僧问道士的祈祷是否带来了雨水（Did the Daoist prayers bring rain?），prayers 在这里指道士所做的祈雨仪式。',
      examples: [
    ...
    },
    {
      ...
      phonetic: '/ˈfeɪdɪd/',
      brief: '渐渐消失，褪去',
      pos: 'verb (past tense of fade)',
      detail:
        'fade 指颜色、声音、表情等逐渐变淡或消失。原文中唐僧听到国王遭遇后笑容 faded（消失了），表现出从开心到震惊的情感转变。',
      examples: [
        'The colors of the painting have faded.（画的颜色已经褪了。）',
        'His smile faded when he heard the news.（听到消息后他的笑容消失了。）',
      ],
      synonyms: [
        { word: 'vanished', note: '突然消失，速度更快' },
        { word: 'diminished', note: '减少、变弱，更正式' },
      ],
    },
    {
      word: 'sealed',
      phonetic: '/siːld/',
      brief: '封住，密封',
      pos: 'verb (past tense of seal)',
      detail:
        'seal 作动词指封闭、密封，使某物无法打开。原文中道士把国王推入井后 sealed the well shut（把井口封死），seal shut 是常见搭配，意为把某物封死。',
      examples: [
        'The envelope was sealed with wax.（信封用蜡封住了。）',
        'They sealed the entrance to the cave.（他们封住了洞穴入口。）',
      ],
      synonyms: [
        { word: 'blocked', note: '堵住，更通用' },
        { word: 'closed', note: '关闭，程度较轻' },
      ],
    },
    {
      word: 'shut',
      ...
      pos: 'adverb / adjective',
      detail:
        'shut 在此处作副词修饰 sealed，表示紧闭地、严实地。seal shut 是固定搭配，意为封死、关紧。shut 的原形、过去式和过去分词相同（shut - shut - shut）。',
      examples: [
        'Keep your mouth shut.（闭嘴。）',
        'The door was shut tight.（门关得紧紧的。）',
      ],
      synonyms: [
        { word: 'closed', note: '关闭，语气不如 shut 强烈' },
      ],
    },
    {
      word: 'guards',
      phonetic: '/ɡɑːrdz/',
      brief: '卫兵，侍卫',
      pos: 'noun (plural of guard)',
      detail:
        'guard 指负责守卫或保护的人。原文中唐僧问 Your guards punished the Daoist, right?（你的卫兵惩罚了那个道士对吧？），以为国王的卫兵会为国王报仇。',
      examples: [
        'The guards stood at the palace gate.（卫兵站在宫殿门口。）',
        'Security guards patrol the building at night.（保安夜间巡逻大楼。）',
      ],
      synonyms: [
        { word: 'soldiers', note: '士兵，侧重军事职能' },
        { word: 'bodyguards', note: '保镖，侧重个人保护' },
      ],
    },
    {
      word: 'ever since',
      ...
      pos: 'phrase',
      detail:
        'ever since 表示从过去某个时间点到现在一直如此，强调持续的状态。原文中国王的鬼魂说自己 ever since 都待在阴间，表示从被推入井中死亡后一直困在那里。',
      examples: [
        'He moved to New York and has lived there ever since.（他搬到了纽约从那以后一直住在那里。）',
        'She has been afraid of dogs ever since she was bitten.（自从被咬后她一直怕狗。）',
      ],
      synonyms: [
        { word: 'since then', note: '从那时起，语气稍弱' },
      ],
    },
    {
      word: 'charge',
      ...
      pos: 'verb',
      detail:
        'charge 在此处作动词，意为猛冲、冲锋，带有强烈的方向感和速度感。原文中唐僧说悟空不能 charge into the palace（冲进宫殿），意思是不能鲁莽地闯入皇宫。charge 还有充电、收费、指控等多种含义。',
      examples: [
        'The bull charged at the matador.（公牛向斗牛士冲去。）',
        'He was charged with murder.（他被指控犯有谋杀罪。）',
      ],
      synonyms: [
        { word: 'rush', note: '冲、跑，更通用' },
        { word: 'dash', note: '猛冲，强调速度' },
      ],
    },
    {
      word: 'private',
      ...
      pos: 'adjective',
      detail:
        'private 意为私人的、私下的，与 public（公开的）相对。原文中 fight the Daoist in private（私下里和道士打斗），意思是不要在众人面前动手避免引起恐慌。',
      examples: [
        'Can I speak to you in private?（我能私下和你谈谈吗？）',
        'This is a private matter.（这是私事。）',
      ],
      synonyms: [
        { word: 'secret', note: '秘密的，更强调不被人知晓' },
        { word: 'personal', note: '个人的，侧重属于个人' },
      ],
    },
    {
      word: 'hunting',
      phonetic: '/ˈhʌntɪŋ/',
      brief: '打猎，狩猎',
      pos: 'verb (present participle of hunt) / noun',
      detail:
        'hunting 指打猎活动，hunt 的动名词形式。原文中国王说太子明天会出去打猎（He will be out hunting tomorrow），这是古代皇室常见的活动。',
      examples: [
        'They went hunting in the forest.（他们去森林里打猎了。）',
        'Hunting is a popular sport in some countries.（打猎在一些国家是一项流行的运动。）',
      ],
      synonyms: [
        { word: 'chasing', note: '追逐，不限于猎物' },
      ],
    },
    {
      word: 'jade coin',
      ...
      pos: 'noun',
      detail:
        'jade 意为玉，coin 意为硬币、钱币。jade coin 是一种玉制的贵重货币或饰品，在中国古代是皇室珍宝。原文中国王将玉币交给唐僧作为信物，太子看到玉币就能确认唐僧所言属实。',
      examples: [
        'The museum has a collection of ancient jade coins.（博物馆收藏有古代玉币。）',
        'Jade is considered precious in Chinese culture.（玉在中国文化中被视为珍宝。）',
      ],
      synonyms: [
      ],
    },
    {
      ...
      pos: 'adverb',
      detail:
        'though 在此处作副词放在句末，意为不过、然而，表示转折。原文中唐僧说 I do not know where it is now though（不过我不知道它现在在哪里），though 在句末起到可是的转折作用。注意与 although（连词放句首）的区别。',
      examples: [
        'It is a nice car. It is too expensive, though.（车是不错。不过太贵了。）',
        'I am busy. I can help you later, though.（我很忙。不过我可以稍后帮你。）',
      ],
      synonyms: [
        { word: 'however', note: '然而，更正式，通常放句首' },
        { word: 'although', note: '虽然（连词，引导从句，不放句末）' },
      ],
    },
    {
      word: 'making up',
      phonetic: '/ˈmeɪkɪŋ ʌp/',
      brief: '编造，捏造（故事或谎言）',
      pos: 'phrase (phrasal verb make up)',
      detail:
        'make up 在此处意为编造、虚构，尤指编造故事或谎言。原文中太子不相信唐僧的话认为他在 making up such a story（编造这样的故事）。make up 还有化妆、组成、和好等其他含义。',
      examples: [
        'He made up an excuse for being late.（他编了一个迟到的借口。）',
        'Do not make things up.（别瞎编。）',
      ],
      synonyms: [
        { word: 'inventing', note: '发明、编造，带有创造性' },
        { word: 'fabricating', note: '捏造，更正式，带有欺骗性' },
      ],
    },
    {
      word: 'get rid of',
      ...
      pos: 'phrase',
      detail:
        'get rid of 是固定短语，意为除掉、消灭、摆脱。原文中悟空说 We will get rid of that fake king（我们要除掉那个假国王），表示要消灭冒充国王的道士。',
      examples: [
        'We need to get rid of the old furniture.（我们需要处理掉旧家具。）',
        'How do I get rid of this headache?（我怎么才能摆脱这头痛？）',
      ],
      synonyms: [
        { word: 'eliminate', note: '消除，更正式' },
        { word: 'dispose of', note: '处理掉，侧重丢弃' },
      ],
    },
    {
      word: 'deny',
      ...
      pos: 'verb',
      detail:
        'deny 指拒绝承认某事属实。原文中悟空预判道士会 deny everything（否认一切），拒绝承认自己杀害了真国王。deny 后接名词或动名词，不接不定式。',
      examples: [
        'He denied stealing the money.（他否认偷了钱。）',
        'She denied the accusation.（她否认了指控。）',
      ],
      synonyms: [
        { word: 'contradict', note: '反驳，表示与某说法相反' },
        { word: 'refuse', note: '拒绝，侧重不愿做某事' },
      ],
    },
    {
      word: 'poked',
      phonetic: '/poʊkt/',
      brief: '戳，捅',
      pos: 'verb (past tense of poke)',
      detail:
        'poke 指用手指或物体戳、捅某物或某人。本书中出现两次：第一次是悟空戳醒熟睡的八戒；第二次是悟空在老子炼丹房里戳蓝色瓶子，表现出他的顽皮好奇。',
      examples: [
        'She poked him in the ribs.（她戳了戳他的肋骨。）',
        'Do not poke the fire with your fingers.（别用手指戳火。）',
      ],
      synonyms: [
        { word: 'jab', note: '猛戳，力度更大' },
        { word: 'prod', note: '轻戳，多用于催促或引起注意' },
      ],
    },
    {
      word: 'fast asleep',
      ...
      pos: 'phrase',
      detail:
        'fast asleep 是固定搭配意为熟睡，其中 fast 不是快的意思而是完全地、深深地。原文中悟空趁八戒 fast asleep（熟睡）时把他戳醒，引他去井底捞国王的尸体。',
      examples: [
        'The baby is fast asleep.（婴儿睡得正香。）',
        'Within minutes he was fast asleep.（几分钟内他就沉沉睡去了。）',
      ],
      synonyms: [
        { word: 'sound asleep', note: '熟睡，与 fast asleep 同义' },
        { word: 'dead to the world', note: '睡得死死的，更口语化夸张' },
      ],
    },
    {
      word: 'mumbled',
      ...
      pos: 'verb (past tense of mumble)',
      detail:
        'mumble 指说话含糊不清、声音很低，让人听不太清楚。原文中八戒半睡半醒间嘟囔着说 Not now，mumbled Bajie 描写了猪八戒迷迷糊糊不愿被打扰的状态。',
      examples: [
        'He mumbled something I could not hear.（他嘟囔了什么我没听清。）',
        'Stop mumbling and speak clearly.（别含含糊糊的说清楚点。）',
      ],
      synonyms: [
        { word: 'muttered', note: '低声说，可能带有不满情绪' },
        { word: 'grumbled', note: '嘟嘟囔囔地抱怨' },
      ],
    },
    {
      word: 'rotten',
      phonetic: '/ˈrɑːtn/',
      brief: '糟糕的，讨厌的（俚语）；腐烂的',
      pos: 'adjective',
      detail:
        'rotten 本义为腐烂的、变质的，在口语中常用来骂人意为讨厌的、卑劣的。原文中八戒被悟空骗入井中后骂道 You rotten monkey!（你这个臭猴子！），rotten 在这里是骂人的口语用法。',
      examples: [
        'The fruit has gone rotten.（水果已经烂了。）',
        'You rotten liar!（你这个可恶的骗子！）',
      ],
      synonyms: [
        { word: 'spoiled', note: '变质的，侧重食物' },
        { word: 'nasty', note: '令人讨厌的，侧重行为或态度' },
      ],
    },
    {
      word: 'protested',
      phonetic: '/prəˈtestɪd/',
      brief: '抗议，反对，辩解',
      pos: 'verb (past tense of protest)',
      detail:
        'protest 指强烈地反对或为自己辩护。原文中悟空在八戒诬蔑他会救活国王时大声辩解，protested Wukong 在此处意为极力否认、辩解。注意动词重音在第二音节。',
      examples: [
        'That is not fair! she protested.（那不公平！她抗议道。）',
        'He protested his innocence.（他坚称自己无罪。）',
      ],
      synonyms: [
        { word: 'objected', note: '反对，语气较温和' },
        { word: 'argued', note: '争辩，侧重讲理' },
      ],
    },
    {
      word: 'potion',
      ...
      pos: 'noun',
      detail:
        'potion 指有魔法或药效的液体，常见于奇幻文学和神话故事中。原文中老子正在炼制 a potion（药剂），配合蒸汽翻腾的大锅，营造出神秘的炼丹场景。',
      examples: [
        'The witch brewed a magic potion.（女巫熬制了一瓶魔药。）',
        'He drank a sleeping potion.（他喝了一瓶安眠药水。）',
      ],
      synonyms: [
        { word: 'elixir', note: '灵丹妙药，带有神奇色彩' },
        { word: 'brew', note: '酿造的饮料或药剂' },
      ],
    },
    {
      word: 'steam',
      ...
      pos: 'noun',
      detail:
        'steam 指水沸腾后产生的蒸汽。原文中 Steam rose from the bubbling cauldron（蒸汽从翻腾的大锅中升起），描写了老子炼丹时锅里水汽蒸腾的画面。',
      examples: [
        'Steam rose from the hot soup.（热汤冒出蒸汽。）',
        'The bathroom was full of steam.（浴室里满是水蒸气。）',
      ],
      synonyms: [
        { word: 'vapor', note: '蒸气，泛指各种气态物质' },
      ],
    },
    {
      word: 'bubbling cauldron',
      phonetic: '/ˈbʌblɪŋ ˈkɔːldrən/',
      brief: '冒泡的大锅',
      pos: 'noun',
      detail:
        'bubbling 意为冒泡的、翻腾的，cauldron 意为大锅（尤指巫婆或炼金术士用的）。bubbling cauldron 是奇幻文学中的经典意象，代表魔法正在发生。原文中老子的炼丹大锅蒸汽翻腾营造出神秘氛围。',
      examples: [
        'The witches stirred the bubbling cauldron.（女巫们搅动着冒泡的大锅。）',
        'A large cauldron hung over the fire.（一口大锅悬挂在火上。）',
      ],
      synonyms: [
      ],
    },
    {
      ...
      pos: 'verb (past tense of groan)',
      detail:
        'groan 指因疼痛、不满或疲惫而发出低沉的声音。本书中出现两次：第一次是老子看到悟空闯入时的不满；第二次是唐僧对悟空反复犹豫的不耐烦。',
      examples: [
        'He groaned in pain.（他痛苦地呻吟。）',
        'The students groaned when the teacher gave more homework.（老师布置更多作业时学生们发出抱怨声。）',
      ],
      synonyms: [
        { word: 'moaned', note: '呻吟，更多表示悲伤或疼痛' },
        { word: 'sighed', note: '叹气，较轻的不满或无奈' },
      ],
    },
    {
      word: 'equipment',
      ...
      pos: 'noun',
      detail:
        'equipment 是不可数名词，指用于特定目的的设备、工具或器材。原文中悟空在老子的炼丹房里看 all the bottles and equipment（所有的瓶瓶罐罐和器具）。',
      examples: [
        'The lab is equipped with modern equipment.（实验室配备了现代化设备。）',
        'We need to buy new sports equipment.（我们需要买新的运动器材。）',
      ],
      synonyms: [
        { word: 'apparatus', note: '器械，较正式，多指科学仪器' },
        { word: 'tools', note: '工具，更具体可数' },
      ],
    },
    {
      word: 'rude',
      ...
      pos: 'adjective',
      detail:
        'rude 指行为粗鲁、不礼貌。原文中老子对悟空的无理要求忍无可忍骂道 You are rude and disrespectful!（你又无礼又不尊重人！），rude 和 disrespectful 连用加强语气。',
      examples: [
        'It is rude to interrupt people.（打断别人说话是不礼貌的。）',
        'He made a rude gesture.（他做了一个粗鲁的手势。）',
      ],
      synonyms: [
        { word: 'impolite', note: '不礼貌的，较正式' },
        { word: 'disrespectful', note: '不尊重的，侧重缺乏敬意' },
      ],
    },
    {
      word: 'stirred',
      phonetic: '/stɜːrd/',
      brief: '搅拌',
      pos: 'verb (past tense of stir)',
      detail:
        'stir 指用勺子或棍子在液体中搅动。原文中老子回到药锅旁继续搅拌（went back to his potion and stirred），stir 是烹饪和炼丹中的基本动作。stir 的过去式和过去分词都是 stirred（双写 r）。',
      examples: [
        'She stirred the soup with a wooden spoon.（她用木勺搅了搅汤。）',
        'Stir the mixture until it is smooth.（搅拌混合物直到顺滑。）',
      ],
      synonyms: [
        { word: 'mixed', note: '混合，更泛指' },
      ],
    },
    {
      word: 'hood',
      ...
      pos: 'noun',
      detail:
        'hood 指连在衣服上的兜帽或单独戴的头巾，可以遮住头部和脸部。原文中复活的国王戴着兜帽隐藏身份，当他拉下兜帽时道士才认出他是真正的国王。',
      examples: [
        'She pulled up her hood against the rain.（她拉起兜帽挡雨。）',
        'The figure wore a dark hood.（那个人影戴着深色兜帽。）',
      ],
      synonyms: [
        { word: 'cloak', note: '斗篷，整件衣服而非仅帽子' },
      ],
    },
    {
      word: 'tell',
      phonetic: '/tel/',
      brief: '分辨，辨别（与 apart 连用）',
      pos: 'verb',
      detail:
        'tell 在此处意为分辨、辨别，通常与 apart 连用构成短语动词 tell apart。原文中 We cannot tell them apart（我们分辨不出它们），指两个一模一样的唐僧让人无法辨别真假。tell 的常见含义是告诉，但与 apart 连用时意思完全不同。',
      examples: [
        'The twins look so alike, I cannot tell them apart.（这对双胞胎长得太像了我分辨不出来。）',
        'Can you tell the difference between these two colors?（你能分辨这两种颜色的区别吗？）',
      ],
      synonyms: [
        { word: 'distinguish', note: '区分，更正式' },
        { word: 'identify', note: '识别，确认身份' },
      ],
    },
    {
      word: 'apart',
      phonetic: '/əˈpɑːrt/',
      brief: '分开，区别（与 tell 连用）',
      pos: 'adverb',
      detail:
        'apart 意为分开地、相隔地。tell apart 是固定搭配意为分辨、区分。原文中 We cannot tell them apart 表示两个唐僧长得一模一样无法将他们区分开来。',
      examples: [
        'The two houses are two miles apart.（两栋房子相隔两英里。）',
        'He tore the letter apart.（他把信撕碎了。）',
      ],
      synonyms: [
      ],
    },
    {
      ...
      pos: 'verb (past tense of glare)',
      detail:
        'glare 指生气地、长时间地盯着看。本书中出现两次：第一次是假唐僧怒视真唐僧；第二次是悟空愤怒地瞪着伪装成小孩的妖怪，两次都表达了强烈的愤怒。',
      examples: [
        'She glared at him in anger.（她愤怒地瞪着他。）',
        'The teacher glared at the noisy students.（老师怒视着吵闹的学生。）',
      ],
      synonyms: [
        { word: 'scowled', note: '皱眉怒视，侧重面部表情' },
        { word: 'stared', note: '盯着看，不含愤怒情绪' },
      ],
    },
    {
      word: 'swirled',
      ...
      pos: 'verb (past tense of swirl)',
      detail:
        'swirl 指液体或气体旋转、盘旋流动。原文中 Clouds swirled 描写悟空等人追赶青狮时云层在天空中旋转翻涌的壮观场面，增强了空中大战的动感。',
      examples: [
        'The leaves swirled in the wind.（树叶在风中旋转。）',
        'Smoke swirled up from the chimney.（烟从烟囱里盘旋升起。）',
      ],
      synonyms: [
        { word: 'spun', note: '旋转，速度更快' },
        { word: 'whirled', note: '急速旋转，带有呼啸感' },
      ],
    },
    {
      word: 'strike',
      ...
      pos: 'verb',
      detail:
        'strike 作动词意为打击、击打。原文中悟空举起金箍棒 raised it to strike（举起准备打击），描述悟空即将对青狮发起攻击的动作。strike 的过去式是 struck。',
      examples: [
        'He raised his sword to strike.（他举剑准备劈下去。）',
        'The snake struck at its prey.（蛇向猎物发起攻击。）',
      ],
      synonyms: [
        { word: 'attack', note: '攻击，更泛指各种进攻' },
        { word: 'hit', note: '打、击，更口语化' },
      ],
    },
    {
      word: 'cruel',
      ...
      pos: 'adjective',
      detail:
        'cruel 指故意使他人或动物遭受痛苦，缺乏同情心。原文中文殊菩萨解释说乌鸡国国王多年前曾 was cruel to someone（对某人很残忍），所以他的坐骑青狮下凡惩罚国王。',
      examples: [
        'It is cruel to keep wild animals in cages.（把野生动物关在笼子里是残忍的。）',
        'The cruel king treated his people badly.（残忍的国王虐待他的百姓。）',
      ],
      synonyms: [
        { word: 'mean', note: '刻薄的，程度较轻' },
        { word: 'brutal', note: '野蛮残暴的，程度更重' },
      ],
    },
    {
      word: 'mysterious',
      ...
      pos: 'adjective',
      detail:
        'mysterious 指难以理解或解释的，带有神秘感。原文中悟空看到一座山上出现 a mysterious red cloud（一朵神秘的红云），预感到前方有妖怪。',
      examples: [
        'A mysterious stranger appeared at the door.（一个神秘的陌生人出现在门口。）',
        'There was a mysterious noise in the attic.（阁楼里传来神秘的声响。）',
      ],
      synonyms: [
        { word: 'eerie', note: '诡异、令人不安的' },
        { word: 'puzzling', note: '令人困惑的，侧重费解' },
      ],
    },
    {
      word: 'leads',
      phonetic: '/liːdz/',
      brief: '通向，延伸到',
      pos: 'verb (third person singular of lead)',
      detail:
        'lead 作动词意为引导、通向。原文中 The road leads right into those mountains（这条路一直通向那些山），leads 在此处表示道路的方向和终点。注意 lead 的过去式是 led。',
      examples: [
        'This path leads to the beach.（这条小路通向海滩。）',
        'All roads lead to Rome.（条条大路通罗马。）',
      ],
      synonyms: [
        { word: 'connects', note: '连接，侧重两端相通' },
      ],
    },
    {
      word: 'alongside',
      phonetic: '/əˈlɔːŋˈsaɪd/',
      brief: '在旁边，沿着',
      pos: 'preposition / adverb',
      detail:
        'alongside 意为在某物旁边、沿着某物。原文中妖怪变成小孩坐在路边（sat alongside it），等待取经团队经过以便欺骗唐僧。',
      examples: [
        'She sat alongside her friend.（她坐在朋友旁边。）',
        'The boat docked alongside the pier.（船停靠在码头旁边。）',
      ],
      synonyms: [
        { word: 'beside', note: '在旁边，更通用' },
        { word: 'next to', note: '紧挨着，更口语化' },
      ],
    },
    {
      word: 'horrified',
      ...
      pos: 'adjective',
      detail:
        'horrified 指因恐惧或震惊而吓坏了。原文中伪装成小孩的妖怪听到悟空揭穿身份后装出 horrified（惊恐万分）的样子，实际上是在演戏骗唐僧。',
      examples: [
        'She was horrified by the accident.（她被那场事故吓坏了。）',
        'The parents were horrified to see their child missing.（父母发现孩子不见了吓坏了。）',
      ],
      synonyms: [
        { word: 'terrified', note: '极度恐惧的，程度更强' },
        { word: 'shocked', note: '震惊的，侧重意外' },
      ],
    },
    {
      word: 'snapped',
      phonetic: '/snæpt/',
      brief: '厉声说，怒斥',
      pos: 'verb (past tense of snap)',
      detail:
        'snap 在此处意为厉声说话、怒斥，带有突然性和不悦。原文中唐僧对悟空厉声说 Wukong! snapped the Tang Monk（唐僧厉声道），因为悟空在吓唬那个小孩。snap 还有折断、咬、拍等多种含义。',
      examples: [
        'Stop it! she snapped.（住手！她厉声说道。）',
        'He snapped the stick in half.（他把棍子折成两段。）',
      ],
      synonyms: [
        { word: 'barked', note: '大声吼叫，更粗暴' },
        { word: 'scolded', note: '责备，带有教育的意味' },
      ],
    },
    {
      word: 'injured',
      ...
      pos: 'adjective / verb (past participle of injure)',
      detail:
        'injured 意为受伤的，可作形容词或动词过去分词。原文中妖怪假装 My leg is injured（我的腿受伤了），骗唐僧让悟空背着走。injure 比 hurt 更正式，比 wound 更通用。',
      examples: [
        'Three people were injured in the accident.（三个人在事故中受伤。）',
        'He injured his knee playing soccer.（他踢足球时伤了膝盖。）',
      ],
      synonyms: [
        { word: 'hurt', note: '受伤，更口语化' },
        { word: 'wounded', note: '受创，多指刀伤枪伤等外伤' },
      ],
    },
    {
      word: 'uprooting',
      phonetic: '/ʌpˈruːtɪŋ/',
      brief: '连根拔起',
      pos: 'verb (present participle of uproot)',
      detail:
        'uproot 指将植物连根拔起，也可比喻使背井离乡。原文中妖怪引发狂风 uprooting trees（连根拔起树木），描写了妖风的巨大威力，树木不是被吹断而是被整棵拔起。',
      examples: [
        'The storm uprooted several trees.（暴风雨把几棵树连根拔起。）',
        'The flood uprooted many families from their homes.（洪水使许多家庭背井离乡。）',
      ],
      synonyms: [
        { word: 'tearing out', note: '撕裂拔出，动作更暴力' },
      ],
    },
    {
      word: 'dust',
      ...
      pos: 'noun',
      detail:
        'dust 指干燥细小的沙土、灰尘。原文中妖风刮起后 dust filled the air（尘土弥漫空中），悟空试图透过尘土寻找师父。',
      examples: [
        'The car raised a cloud of dust.（汽车扬起了一阵尘土。）',
        'The old book was covered in dust.（旧书上落满了灰尘。）',
      ],
      synonyms: [
        { word: 'dirt', note: '泥土、污垢，侧重脏' },
        { word: 'sand', note: '沙子，颗粒更大' },
      ],
    },
    {
      word: 'rushed',
      phonetic: '/rʌʃt/',
      brief: '冲过去，急忙跑',
      pos: 'verb (past tense of rush)',
      detail:
        'rush 指急速移动或行动，带有紧迫感。原文中悟空听到惨叫声后 rushed ahead to find his friends（冲上前去找朋友），表现出他焦急的心情。',
      examples: [
        'She rushed to the hospital.（她急忙赶往医院。）',
        'The students rushed out of the classroom.（学生们冲出教室。）',
      ],
      synonyms: [
        { word: 'dashed', note: '猛冲，更强调速度' },
        { word: 'hurried', note: '匆忙，稍温和' },
      ],
    },
    {
      word: 'frantically',
      ...
      pos: 'adverb',
      detail:
        'frantically 是 frantic 的副词形式，意为疯狂地、拼命地、极其焦急地。原文中悟空发现唐僧不见了后 looked frantically around（疯狂地四处张望），表现出他极度焦急不安的状态。',
      examples: [
        'She searched frantically for her lost keys.（她拼命寻找丢失的钥匙。）',
        'He waved his arms frantically to get attention.（他拼命挥动手臂引起注意。）',
      ],
      synonyms: [
        { word: 'desperately', note: '绝望地、不顾一切地' },
        { word: 'wildly', note: '狂乱地，缺乏控制' },
      ],
    },
  ],
  book_09: [
    {
      ...
      pos: 'adjective',
      detail:
        '此处 serious 表示"认真的、不是开玩笑的"。悟空说他不是真的想回家（I wasn\'t serious about going home），意思是他只是说说而已，并非真心打算放弃取经。serious 也可表示"严重的"，需根据上下文区分。',
      examples: [
        'Are you serious about quitting your job?（你辞职是认真的吗？）',
        'The situation is very serious.（局势非常严重。）',
      ],
      synonyms: [
        { word: 'earnest', note: '真诚的、郑重其事的，强调态度诚恳' },
        { word: 'sincere', note: '发自内心的、真实的，强调没有虚假' },
      ],
    },
    {
      word: 'figure out',
      ...
      pos: 'phrasal verb',
      detail:
        'figure out 是常见的短语动词，意为通过思考或调查"弄清楚、想出解决办法"。原文中悟空说需要弄清楚妖怪把师父带到了哪里（We need to figure out where the demon took him）。',
      examples: [
        'I can\'t figure out how to open this box.（我想不出怎么打开这个盒子。）',
        'We need to figure out a plan.（我们需要想出一个计划。）',
      ],
      synonyms: [
        { word: 'work out', note: '弄明白、解决，偏重"算出结果"' },
        { word: 'solve', note: '解决（问题），更正式' },
      ],
    },
    {
      word: 'summon',
      ...
      pos: 'verb',
      detail:
        'summon 意为"召唤、召集"，通常指用法术或权威将某人/某物召唤过来。原文中悟空说"I\'ll summon a local spirit"，即他要用法术召唤当地的山神来询问信息。后面龙王也说"I can summon rain clouds"，用法相似。',
      examples: [
        'The king summoned his advisors.（国王召集了他的顾问们。）',
        'She summoned all her courage.（她鼓起了全部勇气。）',
      ],
      synonyms: [
        { word: 'call', note: '叫、呼唤，最普通的用词' },
        { word: 'conjure', note: '用法术召唤，更具魔幻色彩' },
      ],
    },
    {
      word: 'muttered',
      ...
      pos: 'verb (past tense of mutter)',
      detail:
        'mutter 指小声、含糊地说话，通常是自言自语或不希望别人听清。原文中悟空闭眼低声念咒语召唤山神（muttered some words），后面八戒也不满地嘟囔（muttered Bajie）。',
      examples: [
        'He muttered something under his breath.（他低声嘀咕了什么。）',
        '"I don\'t want to go," she muttered.（"我不想去，"她嘟囔着。）',
      ],
      synonyms: [
        { word: 'murmur', note: '低语、轻声说，语气更柔和' },
        { word: 'whisper', note: '耳语、悄悄说，强调声音极小' },
      ],
    },
    {
      word: 'breeze',
      ...
      pos: 'noun',
      detail:
        'breeze 指轻柔的风，比 wind 更温和。原文中悟空念完咒语后，一阵轻柔的风吹过（A soft breeze blew），随后山神出现。这里的微风暗示法术正在生效，是一种烘托氛围的写法。',
      examples: [
        'A gentle breeze blew through the trees.（一阵微风穿过树林。）',
        'The sea breeze was very refreshing.（海风令人心旷神怡。）',
      ],
      synonyms: [
        { word: 'wind', note: '泛指风，范围更广，可大可小' },
        { word: 'gust', note: '一阵强风，短暂而猛烈' },
      ],
    },
    {
      word: 'peak',
      ...
      pos: 'noun',
      detail:
        'peak 指山的最高点、山顶。原文中山神说红孩儿的洞在山顶附近（near the peak of that mountain），后来悟空等人也在山顶附近找到了洞穴。本书中 peak 多次出现，都指山峰。',
      examples: [
        'They reached the peak at dawn.（他们在黎明时到达了山顶。）',
        'The mountain peak was covered in snow.（山顶被雪覆盖。）',
      ],
      synonyms: [
        { word: 'summit', note: '顶点、峰会，更正式，也用于抽象意义' },
        { word: 'top', note: '顶部，最普通用词' },
      ],
    },
    {
      word: 'spread',
      ...
      pos: 'verb',
      detail:
        '此处 spread 表示笑容在脸上"蔓延开来"（A smile spread across Wukong\'s face）。spread 本意是"展开、铺开"，用于形容笑容时，生动地表现出笑容从嘴角逐渐扩大的动态过程。',
      examples: [
        'A smile spread across her face.（笑容在她脸上绽放开来。）',
        'The fire spread quickly through the forest.（大火在森林中迅速蔓延。）',
      ],
      synonyms: [
        { word: 'stretch', note: '伸展、拉长，强调物理上的延伸' },
        { word: 'expand', note: '扩大、扩展，更正式' },
      ],
    },
    {
      word: 'demanded',
      ...
      detail:
        'demand 意为"强烈要求"，语气比 ask 重得多，带有命令的口吻。原文中红孩儿见到悟空时厉声质问（"Who are you?" demanded Red Boy），表现出他的傲慢和不耐烦。后面悟空也用 demanded 语气质问龙王。',
      examples: [
        '"What do you want?" she demanded.（"你要什么？"她厉声问道。）',
        'The workers demanded higher pay.（工人们要求提高工资。）',
      ],
      synonyms: [
        { word: 'ask', note: '问、请求，语气最普通' },
        { word: 'require', note: '需要、要求，偏正式' },
      ],
    },
    {
      word: 'snorted',
      ...
      pos: 'verb (past tense of snort)',
      detail:
        'snort 本意是用鼻子猛烈喷气。此处红孩儿对悟空的要求嗤之以鼻（Red Boy snorted），表现他对悟空的蔑视和不屑。这个动作在英语中常用于表达嘲讽或不以为然。',
      examples: [
        'He snorted in disgust.（他厌恶地哼了一声。）',
        '"You think you can beat me?" she snorted.（"你觉得你能赢我？"她嗤笑道。）',
      ],
      synonyms: [
        { word: 'scoffed', note: '嘲笑、冷笑，语气更强烈' },
        { word: 'sneered', note: '嗤笑、讥笑，带有面部表情' },
      ],
    },
    {
      word: 'punched',
      phonetic: '/pʌntʃt/',
      brief: '用拳猛击',
      pos: 'verb (past tense of punch)',
      detail:
        'punch 指用拳头猛击。原文中红孩儿用拳头猛击自己的鼻子（punched himself in the nose），从而触发他的火焰法术——鼻孔喷烟、口中吐火。这个独特的施法方式是红孩儿的标志性动作。',
      examples: [
        'He punched the wall in anger.（他愤怒地捶墙。）',
        'She punched him on the shoulder.（她在他肩膀上捶了一拳。）',
      ],
      synonyms: [
        { word: 'hit', note: '打、击，最普通的用词' },
        { word: 'strike', note: '击打、敲击，更正式，可用于各种打击' },
      ],
    },
    {
      word: 'nostrils',
      ...
      pos: 'noun (plural)',
      detail:
        'nostril 指鼻孔，复数为 nostrils。原文中红孩儿从鼻孔喷出浓烟（Smoke poured from his nostrils），这是他火焰法术的一部分。',
      examples: [
        'Smoke poured from his nostrils.（浓烟从他的鼻孔中涌出。）',
        'The horse flared its nostrils.（那匹马张大了鼻孔。）',
      ],
    },
    {
      word: 'roasted',
      phonetic: '/ˈroʊstɪd/',
      brief: '被烤了，烤焦了',
      pos: 'verb (past participle of roast)',
      detail:
        'roast 本意是"烤、烘烤"食物。此处八戒夸张地说"我们差点被烤了！"（We were nearly roasted!），用被火烤来形容差点被红孩儿的三昧真火烧死的危险。',
      examples: [
        'The chicken was perfectly roasted.（鸡肉烤得恰到好处。）',
        'We were roasting in the hot sun.（我们在烈日下快被烤焦了。）',
      ],
      synonyms: [
        { word: 'burned', note: '烧焦、烧伤，强调被火伤害' },
        { word: 'grilled', note: '烤制（食物），与 roast 类似但多用明火' },
      ],
    },
    {
      word: 'dying down',
      phonetic: '/ˈdaɪɪŋ daʊn/',
      brief: '逐渐减弱，渐渐平息',
      pos: 'phrasal verb',
      detail:
        'die down 是短语动词，意为"逐渐减弱、平息"，常用于描述风、火、声音等自然现象。原文中悟净看到山上的火正在渐渐熄灭（The fire is dying down now）。',
      examples: [
        'The wind is dying down.（风渐渐停了。）',
        'The noise finally died down.（噪音终于渐渐消失了。）',
      ],
      synonyms: [
        { word: 'subside', note: '平息、减弱，更正式' },
        { word: 'fade away', note: '逐渐消失，强调从有到无的过程' },
      ],
    },
    {
      word: 'wisps',
      ...
      pos: 'noun (plural)',
      detail:
        'wisp 指纤细的一缕烟、雾或头发。复数 wisps 指多缕。原文中悟空看着最后几缕烟散去（the last few wisps of smoke），描写火焰即将完全熄灭的景象。',
      examples: [
        'Wisps of fog hung in the air.（一缕缕薄雾悬浮在空中。）',
        'A wisp of smoke rose from the chimney.（一缕烟从烟囱升起。）',
      ],
    },
    {
      word: 'pounded',
      phonetic: '/ˈpaʊndɪd/',
      brief: '猛敲，连续重击',
      pos: 'verb (past tense of pound)',
      detail:
        'pound 指反复用力敲打。原文中悟空用力猛敲红孩儿的洞门（The monkey pounded on the cave door），比普通的敲门（knocked）力度大得多，表现出悟空的急切和气势。',
      examples: [
        'She pounded on the door.（她猛力敲打房门。）',
        'He pounded the table with his fist.（他用拳头猛击桌子。）',
      ],
      synonyms: [
        { word: 'banged', note: '猛撞、砰砰敲，声音更大' },
        { word: 'hammered', note: '反复敲打，像用锤子一样' },
      ],
    },
    {
      word: 'rumbled',
      ...
      detail:
        'rumble 指发出低沉持续的轰隆声。原文中雷声隆隆（Thunder rumbled），描绘龙王召唤暴风雨时雷声大作的场景。后面海中传来隆隆声（the water rumbled）则是花瓶从海底浮上来时的声响。',
      examples: [
        'Thunder rumbled in the distance.（远处雷声隆隆。）',
        'His stomach rumbled with hunger.（他饿得肚子咕噜叫。）',
      ],
      synonyms: [
        { word: 'thundered', note: '打雷、轰鸣，更响亮' },
        { word: 'growled', note: '低吼、咆哮，多用于动物' },
      ],
    },
    {
      word: 'thick',
      ...
      pos: 'adjective',
      detail:
        'thick 常见意思是"厚的"，此处指烟"浓密得令人窒息"。原文中红孩儿的魔法火焰产生的烟越来越浓（The smoke became thick），浓到悟空无法呼吸、无法看清路。',
      examples: [
        'The smoke was too thick to see through.（烟太浓了，什么也看不见。）',
        'Thick fog covered the city.（浓雾笼罩了城市。）',
      ],
      synonyms: [
        { word: 'dense', note: '密集的、浓密的，更正式' },
        { word: 'heavy', note: '重的，也可形容烟/雾浓厚' },
      ],
    },
    {
      word: 'tumbled down',
      phonetic: '/ˈtʌmbld daʊn/',
      brief: '翻滚着跌落',
      pos: 'phrasal verb',
      detail:
        'tumble down 意为"跌落、滚落"，强调失去平衡后的翻滚坠落。原文中悟空被浓烟呛到，绊到石头后从山腰翻滚而下（tumbled down the side of the mountain），非常狼狈。',
      examples: [
        'She tumbled down the stairs.（她从楼梯上滚落下来。）',
        'Rocks tumbled down the hillside.（岩石从山坡上滚落。）',
      ],
      synonyms: [
        { word: 'fell', note: '落下、跌落，最普通用词' },
        { word: 'rolled down', note: '滚下来，强调滚动动作' },
      ],
    },
    {
      word: 'washed up',
      ...
      pos: 'phrasal verb',
      detail:
        'wash up 此处意为"被水冲到岸上"。原文中悟空从山上跌入河中，被水流冲到河岸上（washed up on the riverbank）。wash up 也可指"洗碗"，需根据语境区分。',
      examples: [
        'The body washed up on the beach.（尸体被冲上了海滩。）',
        'Debris washed up along the shore.（碎片被冲到了岸边。）',
      ],
      synonyms: [
        { word: 'drifted ashore', note: '漂到岸上，更缓慢自然' },
        { word: 'landed', note: '着陆、到达，更宽泛' },
      ],
    },
    {
      word: 'wheezing',
      phonetic: '/ˈhwiːzɪŋ/',
      brief: '气喘吁吁，呼哧呼哧地喘',
      pos: 'verb (present participle of wheeze)',
      detail:
        'wheeze 指呼吸困难时发出嘶嘶的喘息声，通常是因为哮喘、烟雾等导致的呼吸不畅。原文中悟空被烟呛到后躺在河岸上，一边咳嗽一边喘（coughing and wheezing），形象地描写了他受伤后的状态。',
      examples: [
        'The old man was wheezing after climbing the stairs.（老人爬完楼梯后气喘吁吁。）',
        'She was coughing and wheezing all night.（她整晚又咳又喘。）',
      ],
      synonyms: [
        { word: 'panting', note: '大口喘气，多因运动' },
        { word: 'gasping', note: '倒吸气、喘不上气，更急促' },
      ],
    },
    {
      word: 'doubt',
      ...
      pos: 'verb',
      detail:
        '此处假观音说"I doubt he\'ll harm the Tang Monk"，doubt 表示"我怀疑他不会伤害唐僧"，即"我认为他不会"。doubt 后接 that 从句时，表示"认为…不太可能"。',
      examples: [
        'I doubt it will rain today.（我怀疑今天不会下雨。）',
        'Nobody doubted his ability.（没有人怀疑他的能力。）',
      ],
      synonyms: [
        { word: 'suspect', note: '怀疑、猜测，但 suspect 常指"觉得某事是真的"' },
        { word: 'question', note: '质疑，表示提出疑问' },
      ],
    },
    {
      word: 'appearance',
      ...
      pos: 'noun',
      detail:
        'appearance 指"外表、样子"。原文中红孩儿从假观音的样子变回了自己本来的模样（returned to his normal appearance），说明他之前的变化术解除了。',
      examples: [
        'Don\'t judge people by their appearance.（不要以貌取人。）',
        'He changed his appearance with a disguise.（他用伪装改变了外貌。）',
      ],
      synonyms: [
        { word: 'look', note: '外表、样子，更口语化' },
        { word: 'outward form', note: '外在形态，更正式' },
      ],
    },
    {
      word: 'sack',
      ...
      pos: 'noun',
      detail:
        'sack 指大号的粗布袋或麻袋，常用于装粮食等。原文中红孩儿趁八戒不备，用一个袋子套住了他（threw a sack over the pig），这是捕获猎物的动作。',
      examples: [
        'He carried a sack of potatoes.（他扛着一袋土豆。）',
        'The thief put the jewels in a sack.（小偷把珠宝塞进了麻袋。）',
      ],
      synonyms: [
        { word: 'bag', note: '袋子，最普通用词' },
        { word: 'pouch', note: '小袋子、荷包' },
      ],
    },
    {
      word: 'slipped',
      ...
      pos: 'verb (past tense of slip)',
      detail:
        'slip 此处意为"悄悄穿过、溜进"，强调动作轻盈不引人注意。原文中悟空变成蜜蜂，轻轻穿过洞门飞入洞内（slipped through the cave door），与他平常破门而入的风格形成对比。',
      examples: [
        'She slipped through the door unnoticed.（她悄悄溜过门没被注意。）',
        'He slipped a note into her hand.（他偷偷把纸条塞进她手里。）',
      ],
      synonyms: [
        { word: 'crept', note: '蹑手蹑脚地走，强调安静' },
        { word: 'glided', note: '滑行、掠过，更优雅流畅' },
      ],
    },
    {
      word: 'filthy',
      ...
      pos: 'adjective',
      detail:
        'filthy 意为"非常脏的"或"卑鄙下流的"，比 dirty 程度更强。此处八戒怒骂红孩儿"你这个卑劣的妖怪！"（You filthy demon!），用 filthy 表达强烈的愤怒和鄙视。',
      examples: [
        'Take off those filthy shoes!（把那双脏鞋脱掉！）',
        'He called me a filthy liar.（他骂我是个卑劣的骗子。）',
      ],
      synonyms: [
        { word: 'dirty', note: '脏的，程度较轻' },
        { word: 'foul', note: '恶臭的、邪恶的，语气更重' },
      ],
    },
    {
      word: 'vase',
      ...
      pos: 'noun',
      detail:
        'vase 指花瓶或装饰性的瓶形容器。原文中观音手中的净瓶（vase）是佛教法宝，能装下四海之水，用来浇灭红孩儿的三昧真火。这个净瓶在故事中反复出现。',
      examples: [
        'She put fresh flowers in the vase.（她把鲜花插进花瓶。）',
        'The ancient vase was very valuable.（这个古花瓶非常珍贵。）',
      ],
    },
    {
      word: 'stormed',
      phonetic: '/stɔːrmd/',
      brief: '怒气冲冲地走出去',
      pos: 'verb (past tense of storm)',
      detail:
        'storm 此处不是"暴风雨"的名词用法，而是动词，意为"怒气冲冲地移动"。原文中观音得知红孩儿冒充自己后大怒，抓起净瓶怒气冲冲地走出室外（stormed outside），表现她罕见的愤怒。',
      examples: [
        'She stormed out of the room.（她怒气冲冲地冲出房间。）',
        'He stormed into the office, demanding answers.（他怒气冲冲地闯进办公室要说法。）',
      ],
      synonyms: [
        { word: 'marched', note: '大步走，不一定生气' },
        { word: 'burst out', note: '冲出去，强调突然性' },
      ],
    },
    {
      word: 'shore',
      ...
      pos: 'noun',
      detail:
        'shore 指水域的岸边。原文中巨龟驮着净瓶来到岸边（The turtle came onto the shore），指大海与陆地交界的地方。',
      examples: [
        'We walked along the shore.（我们沿着岸边走。）',
        'The boat pulled up to the shore.（船靠岸了。）',
      ],
      synonyms: [
        { word: 'bank', note: '河岸，多用于河流' },
        { word: 'coast', note: '海岸线，范围更广' },
      ],
    },
    {
      word: 'grunted',
      ...
      pos: 'verb (past tense of grunt)',
      detail:
        'grunt 指发出低沉的哼声或咕噜声，通常表示用力或不满。原文中悟空试图举起净瓶时"嗯"了一声使出全力（Wukong grunted and used all of his strength），后面的哼声则来自红孩儿用力刺出长枪。',
      examples: [
        'He grunted as he lifted the heavy box.（他举起沉重的箱子时哼了一声。）',
        'She grunted in reply.（她哼了一声作为回应。）',
      ],
      synonyms: [
        { word: 'groaned', note: '呻吟，多因疼痛或疲劳' },
        { word: 'panted', note: '喘气，多因呼吸急促' },
      ],
    },
    {
      word: 'traveled around',
      phonetic: '/ˈtrævld əˈraʊnd/',
      brief: '周游，四处游历',
      pos: 'phrasal verb',
      detail:
        'travel around 意为"四处旅行、游遍"。原文中观音说净瓶刚刚周游了全世界，穿过了所有海洋和河流（just traveled around the world, through all the oceans and rivers），解释了为什么净瓶现在装满了四海之水。',
      examples: [
        'She traveled around Europe last summer.（她去年夏天游遍了欧洲。）',
        'He has traveled around the world twice.（他环游世界两次了。）',
      ],
      synonyms: [
        { word: 'journeyed through', note: '穿越、行经，更正式' },
        { word: 'toured', note: '观光旅行，强调有目的地游览' },
      ],
    },
    {
      word: 'several',
      ...
      pos: 'determiner',
      detail:
        'several 指三个以上但不多，"几个、数个"。原文中观音举起另一只手，几把剑出现在空中（several swords appeared），然后这些剑变成了一朵大莲花台。',
      examples: [
        'Several people were injured in the accident.（事故中有几个人受伤。）',
        'I\'ve read this book several times.（这本书我已经读了好几遍。）',
      ],
      synonyms: [
        { word: 'a few', note: '几个，数量比 several 稍少' },
        { word: 'various', note: '各种各样的，强调多样性而非数量' },
      ],
    },
    {
      ...
      pos: 'noun',
      detail:
        'lotus 是莲花，在佛教中是神圣的象征。原文中观音将几把剑变成了一座巨大的莲花台（a large lotus platform），后来这个莲花台成了困住红孩儿的机关——红孩儿坐上去后，莲花变回利剑将他困住。',
      examples: [
        'The lotus is a symbol of purity in Buddhism.（莲花在佛教中是纯洁的象征。）',
        'Lotus flowers bloom in summer.（莲花在夏天盛开。）',
      ],
    },
    {
      word: 'below',
      ...
      pos: 'adverb',
      detail:
        'below 此处作为副词，指在脚下的位置。原文中悟空站在莲花台上俯视地面（watched the ground below），从这里他看到各种动物从山上逃出。',
      examples: [
        'The valley below was covered in mist.（下面的山谷笼罩在薄雾中。）',
        'From the top, we could see the city below.（从顶上我们能看到下方的城市。）',
      ],
      synonyms: [
        { word: 'underneath', note: '在正下方，更强调被覆盖' },
        { word: 'beneath', note: '在下面，较正式/文学化' },
      ],
    },
    {
      word: 'scurry out',
      phonetic: '/ˈskɜːri aʊt/',
      brief: '急匆匆地跑出来',
      pos: 'phrasal verb',
      detail:
        'scurry 指小动物迈着小碎步急匆匆地跑。scurry out 意为"慌忙跑出来"。原文中悟空看到小动物们从灌木丛下急匆匆地跑出来（small animals scurry out from under bushes），因为山神按照观音的命令驱赶动物远离此山。',
      examples: [
        'Mice scurried out of the hole.（老鼠们急匆匆地从洞里跑出来。）',
        'The children scurried out of the classroom when the bell rang.（铃声响后孩子们争先恐后地跑出教室。）',
      ],
      synonyms: [
        { word: 'dart out', note: '飞快冲出，强调速度' },
        { word: 'rush out', note: '涌出、匆忙出来' },
      ],
    },
    {
      word: 'tipped',
      phonetic: '/tɪpt/',
      brief: '倾斜，倾倒',
      pos: 'verb (past tense of tip)',
      detail:
        'tip 此处意为"使倾斜"。原文中观音倾斜净瓶（tipped the vase），瓶中海水便倾泻而出，形成波涛滚滚的洪水，淹没了整座山。',
      examples: [
        'She tipped the bottle to pour out the water.（她倾斜瓶子把水倒出来。）',
        'He tipped his hat to greet her.（他抬了抬帽檐向她致意。）',
      ],
      synonyms: [
        { word: 'tilted', note: '倾斜，最接近的同义词' },
        { word: 'poured', note: '倒出、倾倒，强调液体流出的动作' },
      ],
    },
    {
      word: 'slopes',
      ...
      pos: 'noun (plural)',
      detail:
        'slope 指倾斜的面，复数 slopes 常指山坡。原文中海水顺着山坡倾泻而下（The waves washed down the slopes of the mountain），描述了洪水从上往下冲击山坡的壮观场景。',
      examples: [
        'The ski slopes were covered in fresh snow.（滑雪坡上覆盖着新雪。）',
        'We climbed up the steep slopes.（我们爬上了陡峭的山坡。）',
      ],
      synonyms: [
        { word: 'hillsides', note: '山腰、山坡' },
        { word: 'inclines', note: '斜面，更正式' },
      ],
    },
    {
      word: 'forming',
      phonetic: '/ˈfɔːrmɪŋ/',
      brief: '形成，构成',
      pos: 'verb (present participle of form)',
      detail:
        'form 此处意为"形成"。原文中水位不断升高，最终形成了一片海洋（forming an ocean），只有山顶露出水面。form 强调从无到有的形成过程。',
      examples: [
        'Dark clouds were forming in the sky.（天空中正在形成乌云。）',
        'Ice formed on the lake overnight.（湖水一夜之间结了冰。）',
      ],
      synonyms: [
        { word: 'creating', note: '创造，强调主动性' },
        { word: 'shaping', note: '塑形，强调过程' },
      ],
    },
    {
      word: 'stabbed',
      ...
      pos: 'verb (past tense of stab)',
      detail:
        'stab 指用尖利武器猛刺。原文中红孩儿用长枪向悟空猛刺（stabbed at Wukong with his lance），这是战斗场景中常见的攻击动作。',
      examples: [
        'He stabbed the knife into the table.（他把刀猛插进桌子。）',
        'The knight stabbed at the dragon with his sword.（骑士用剑刺向龙。）',
      ],
      synonyms: [
        { word: 'thrust', note: '猛推、刺入，强调力量' },
        { word: 'pierced', note: '刺穿、穿透，强调穿透结果' },
      ],
    },
    {
      word: 'lance',
      ...
      pos: 'noun',
      detail:
        'lance 指长枪、长矛，是古代骑兵常用的武器。红孩儿使用的武器就是一杆长枪，在故事中多次出现。与 spear 相比，lance 更正式，通常指骑士用的长枪。',
      examples: [
        'The knight lowered his lance and charged.（骑士放下长枪发起冲锋。）',
        'He was armed with a lance and a shield.（他手持长枪和盾牌。）',
      ],
      synonyms: [
        { word: 'spear', note: '矛、枪，更古老的武器' },
        { word: 'pike', note: '长柄武器，步兵用的长矛' },
      ],
    },
    {
      word: 'jabbing',
      phonetic: '/ˈdʒæbɪŋ/',
      brief: '连刺，不断戳',
      pos: 'verb (present participle of jab)',
      detail:
        'jab 指快速、短促地戳或刺。原文中红孩儿在天空中不断用长枪朝悟空连刺（kept jabbing his lance at Wukong），描写激烈的空中追逐战。',
      examples: [
        'He kept jabbing his finger at the map.（他不断地用手指戳地图。）',
        'The boxer jabbed at his opponent.（拳击手不断朝对手出刺拳。）',
      ],
      synonyms: [
        { word: 'stabbing', note: '猛刺，力度更大' },
        { word: 'poking', note: '捅、戳，力度较小' },
      ],
    },
    {
      word: 'ducked',
      ...
      pos: 'verb (past tense of duck)',
      detail:
        'duck 此处作动词，意为"迅速低头或弯腰以躲避"。原文中悟空飞到观音身后迅速闪到她后面（ducked behind her），借助观音来保护自己。',
      examples: [
        'She ducked to avoid the flying ball.（她低头躲过了飞来的球。）',
        'He ducked behind a wall.（他闪到墙后面。）',
      ],
      synonyms: [
        { word: 'dodged', note: '躲闪、闪避，强调灵活避开' },
        { word: 'dived', note: '扑倒、跳开，动作幅度更大' },
      ],
    },
    {
      word: 'stuck',
      phonetic: '/stʌk/',
      brief: '刺向，扎进',
      pos: 'verb (past tense of stick)',
      detail:
        'stick 此处是动词，过去式 stuck，意为"把…指向、扎入"。原文中利剑的尖端从四面八方刺向红孩儿（Sharp points stuck at him on all sides），将他困在莲花台中。',
      examples: [
        'She stuck the needle into the cloth.（她把针刺入布料。）',
        'Thorns stuck into his skin.（荆棘扎进了他的皮肤。）',
      ],
      synonyms: [
        { word: 'pierced', note: '刺穿，强调穿透' },
        { word: 'pointed', note: '指向，没有接触' },
      ],
    },
    {
      word: 'charged',
      phonetic: '/tʃɑːrdʒd/',
      brief: '猛冲，冲向',
      pos: 'verb (past tense of charge)',
      detail:
        'charge 此处意为"猛冲、向…扑过去"。原文中红孩儿被解除束缚后怒气冲冲地朝观音猛扑过去（charged toward Guanyin），表现他的凶狠和不服。',
      examples: [
        'The bull charged at the matador.（公牛向斗牛士冲去。）',
        'He charged into the room, furious.（他怒气冲冲地冲进房间。）',
      ],
      synonyms: [
        { word: 'rushed', note: '冲、赶，速度很快' },
        { word: 'lunged', note: '猛扑，强调突然前冲' },
      ],
    },
    {
      word: 'was about to',
      ...
      pos: 'phrase',
      detail:
        'be about to 表示"正要做某事、即将发生"。原文中悟空正要出手打击红孩儿（was about to strike the demon），但被观音先一步用金箍制止了红孩儿。这个短语常用于描述动作被打断的时刻。',
      examples: [
        'I was about to leave when the phone rang.（我正要离开时电话响了。）',
        'She was about to speak but stopped.（她正要说话但停住了。）',
      ],
      synonyms: [
        { word: 'was going to', note: '打算、准备做，不如 about to 紧迫' },
        { word: 'was on the point of', note: '正要…之际，更正式' },
      ],
    },
    {
      word: 'strike',
      ...
      pos: 'verb',
      detail:
        'strike 意为"猛击、给予一击"。原文中悟空举起铁棒准备猛击红孩儿（raised his iron bar to strike him），但被观音制止。strike 是比 hit 更正式的用词，常用于战斗场景。',
      examples: [
        'He struck the table with his fist.（他用拳头猛击桌子。）',
        'Lightning struck the tree.（闪电击中了那棵树。）',
      ],
      synonyms: [
        { word: 'hit', note: '打、击，最普通用词' },
        { word: 'smash', note: '猛砸、粉碎，力度更大' },
      ],
    },
    {
      word: 'clamped around',
      phonetic: '/klæmpt əˈraʊnd/',
      brief: '紧紧箍住',
      pos: 'phrasal verb',
      detail:
        'clamp around 意为"紧紧夹住、箍住"。原文中观音抛出的五个金属圈瞬间紧紧箍在了红孩儿的头、手腕和脚踝上（they clamped around his head, wrists, and ankles），这就是红孩儿戴上的金箍。',
      examples: [
        'The handcuffs clamped around his wrists.（手铐紧紧扣住了他的手腕。）',
        'She clamped her hand over his mouth.（她紧紧捂住了他的嘴。）',
      ],
      synonyms: [
        { word: 'fastened around', note: '扣紧在…周围' },
        { word: 'gripped', note: '紧紧抓住' },
      ],
    },
    {
      word: 'wrists',
      ...
      pos: 'noun (plural)',
      detail:
        'wrist 指手腕，连接手掌和前臂的关节。原文中金箍箍住了红孩儿的手腕（wrists），使他无法活动。',
      examples: [
        'She grabbed him by the wrist.（她抓住了他的手腕。）',
        'He fell and hurt his wrist.（他摔倒伤了手腕。）',
      ],
    },
    {
      word: 'ankles',
      ...
      pos: 'noun (plural)',
      detail:
        'ankle 指脚踝，连接小腿和脚的关节。原文中金箍不仅箍住了红孩儿的头和手腕，也箍住了脚踝（ankles），让他完全动弹不得。',
      examples: [
        'She twisted her ankle while running.（她跑步时扭伤了脚踝。）',
        'The snow was up to his ankles.（雪深及脚踝。）',
      ],
    },
    {
      word: 'attack',
      ...
      pos: 'verb',
      detail:
        'attack 意为"攻击、进攻"。原文中观音说"你竟敢攻击我！"（How dare you try to attack me!），这是红孩儿在被解除剑阵后试图冲向观音的行为。',
      examples: [
        'The dog attacked the intruder.（狗攻击了闯入者。）',
        'They planned to attack at dawn.（他们计划在黎明时发起攻击。）',
      ],
      synonyms: [
        { word: 'assault', note: '袭击、攻击，更正式，常用于法律语境' },
        { word: 'strike', note: '猛击，强调单次打击' },
      ],
    },
    {
      word: 'then',
      ...
      pos: 'adverb',
      detail:
        'then 是表示时间顺序的副词，意为"然后、接着"。原文中"她然后带领红孩儿向南走"（She then led Red Boy toward the south），then 表示动作的先后顺序。',
      examples: [
        'First we eat, and then we play.（我们先吃饭，然后再玩。）',
        'She finished her homework and then went outside.（她做完作业然后出去了。）',
      ],
      synonyms: [
        { word: 'afterward', note: '之后、后来，更正式' },
        { word: 'next', note: '接下来、下一步' },
      ],
    },
    {
      word: 'canoe',
      ...
      pos: 'noun',
      detail:
        'canoe 指独木舟或小型划艇，通常很窄、用桨划动。原文中一个划着独木舟的男人主动提出载取经人过河，但实际上这个"男人"是蜥蜴精的伪装，独木舟是他设下的陷阱。',
      examples: [
        'We paddled a canoe down the river.（我们划着独木舟顺流而下。）',
        'The canoe was small but steady.（独木舟虽小但很稳。）',
      ],
      synonyms: [
        { word: 'boat', note: '船，最普通用词' },
        { word: 'kayak', note: '皮划艇，类似但有不同结构' },
      ],
    },
    {
      word: 'brightly',
      ...
      pos: 'adverb',
      detail:
        'brightly 此处不是指光线明亮，而是形容说话的语气"欢快地、兴高采烈地"。原文中假船夫听说唐僧后高兴地说"You must be the Tang Monk!" said the man brightly，表现得热情友好，但实际是妖怪伪装。',
      examples: [
        '"What a wonderful day!" she said brightly.（"多美好的一天啊！"她欢快地说。）',
        'He smiled brightly at the news.（听到消息他灿烂地笑了。）',
      ],
      synonyms: [
        { word: 'cheerfully', note: '快乐地、愉快地' },
        { word: 'gladly', note: '乐意地、高兴地' },
      ],
    },
    {
      word: 'eventually',
      ...
      pos: 'adverb',
      detail:
        'eventually 意为"最终、终于"，表示经过一段时间或过程后某事发生了。原文中假船夫说"我听说你最终会经过这一带"（I\'ve heard you would pass through this area eventually），暗示他早已在等待唐僧的到来。',
      examples: [
        'We eventually found the right road.（我们终于找到了正确的路。）',
        'She will eventually understand.（她最终会明白的。）',
      ],
      synonyms: [
        { word: 'finally', note: '最后、终于，强调等待后的结果' },
        { word: 'ultimately', note: '最终、归根结底，更正式' },
      ],
    },
    {
      word: 'glanced',
      ...
      pos: 'verb (past tense of glance)',
      detail:
        'glance 指快速地看一眼，不是仔细注视。原文中假船夫假意低头瞥了一眼自己的独木舟（glanced down at his canoe），然后说船太小一次只能载两个人——这是他的诡计，目的是分拆取经团队。',
      examples: [
        'She glanced at her watch.（她瞥了一眼手表。）',
        'He glanced around the room.（他环顾了一下房间。）',
      ],
      synonyms: [
        { word: 'peeked', note: '偷看、窥视，更隐蔽' },
        { word: 'glimpsed', note: '瞥见，强调看到的结果而非动作' },
      ],
    },
    {
      word: 'passengers',
      phonetic: '/ˈpæsəndʒərz/',
      brief: '乘客，旅客',
      pos: 'noun (plural)',
      detail:
        'passenger 指乘坐交通工具的乘客。原文中假船夫说一次只能载两名乘客（I can take only two passengers at a time），这是为分开唐僧和徒弟们的借口。',
      examples: [
        'The bus can hold 40 passengers.（这辆公交车能载40名乘客。）',
        'All passengers must wear seatbelts.（所有乘客都必须系好安全带。）',
      ],
      synonyms: [
        { word: 'riders', note: '骑/乘坐者，更口语化' },
        { word: 'travelers', note: '旅行者，范围更广' },
      ],
    },
    {
      word: 'trust',
      ...
      pos: 'verb',
      detail:
        'trust 意为"信任、信赖"。原文中唐僧责怪悟空"你从来不信人"（You never trust people），这是唐僧性格的写照——他愿意相信别人的善意，却因此屡次上当。',
      examples: [
        'I trust you completely.（我完全信任你。）',
        'Don\'t trust strangers.（不要信任陌生人。）',
      ],
      synonyms: [
        { word: 'believe', note: '相信，侧重于认可真实性' },
        { word: 'rely on', note: '依赖、依靠，侧重于行动上的信赖' },
      ],
    },
    {
      word: 'willing',
      ...
      pos: 'adjective',
      detail:
        'willing 意为"愿意的、乐意的"，表示某人主动同意做某事。原文中唐僧说"这位好心人愿意帮我们渡河"（This kind man is willing to help us cross the river），可惜他不知道这份"好心"是妖怪的伪装。',
      examples: [
        'She is willing to help.（她愿意帮忙。）',
        'Are you willing to try?（你愿意试试吗？）',
      ],
      synonyms: [
        { word: 'ready', note: '准备好的，强调状态' },
        { word: 'eager', note: '热切的、急切的，积极性更高' },
      ],
    },
    {
      word: 'glide',
      ...
      pos: 'verb',
      detail:
        'glide 意为"平滑地滑行、优雅地移动"，强调动作流畅无阻。原文中悟空看着独木舟在河面上平稳地滑行（watched the canoe glide across the river），画面宁静祥和——然而很快独木舟就开始下沉。',
      examples: [
        'The swan glided across the lake.（天鹅在湖面上优雅地滑行。）',
        'The plane glided to a smooth landing.（飞机滑翔平稳着陆。）',
      ],
      synonyms: [
        { word: 'float', note: '漂浮，强调在水上' },
        { word: 'slide', note: '滑动，可以指任何表面上的滑行' },
      ],
    },
    {
      word: 'surface',
      ...
      pos: 'noun',
      detail:
        'surface 此处指水的表面。原文中独木舟沉入了水面以下（slipped under the surface of the water），描述唐僧和八戒被拖入水中的瞬间。',
      examples: [
        'The fish jumped out of the surface of the water.（鱼跳出了水面。）',
        'The submarine rose to the surface.（潜艇浮上了水面。）',
      ],
      synonyms: [
        { word: 'top', note: '顶部，最普通用词' },
        { word: 'outside', note: '外面，与里面相对' },
      ],
    },
    {
      word: 'suspicious',
      ...
      pos: 'adjective',
      detail:
        'suspicious 意为"可疑的、令人生疑的"。原文中悟空早就觉得那个船夫不对劲（I knew he looked suspicious!），事实证明他的直觉是对的——船夫是蜥蜴精假扮的。',
      examples: [
        'He looked suspicious.（他看起来很可疑。）',
        'The police found the package suspicious.（警方觉得这个包裹很可疑。）',
      ],
      synonyms: [
        { word: 'doubtful', note: '可疑的、不确定的' },
        { word: 'shady', note: '可疑的、不光明正大的，更口语化' },
      ],
    },
    {
      word: 'peeked',
      phonetic: '/piːkt/',
      brief: '偷看，探出头看',
      pos: 'verb (past tense of peek)',
      detail:
        'peek 指快速地偷看或从遮挡物后面探出头看。原文中一只蜥蜴从门后探出头来（a lizard peeked out），这是蜥蜴精的手下应门的场景。',
      examples: [
        'She peeked through the keyhole.（她从钥匙孔偷看。）',
        'The cat peeked out from under the bed.（猫从床底下探出头。）',
      ],
      synonyms: [
        { word: 'glanced', note: '瞥了一眼，快速地看' },
        { word: 'peered', note: '凝视、仔细看，强调看不清楚而努力看' },
      ],
    },
    {
      word: 'shoved',
      phonetic: '/ʃʌvd/',
      brief: '猛推，用力推开',
      pos: 'verb (past tense of shove)',
      detail:
        'shove 指用力猛推。原文中悟净大喊"滚开！"然后用力推开蜥蜴精（He shoved the lizard），这是近身肉搏中的推搡动作。',
      examples: [
        'He shoved the door open.（他猛地把门推开。）',
        'She shoved him out of the way.（她把他推到一边。）',
      ],
      synonyms: [
        { word: 'pushed', note: '推，最普通用词' },
        { word: 'thrust', note: '猛推，力量更大、更突然' },
      ],
    },
    {
      word: 'upward',
      ...
      pos: 'adverb',
      detail:
        'upward 意为"向上、朝上方的方向"。原文中悟净在水下与蜥蜴精搏斗后向上游去（swam upward），最终跳出水面回到悟空身边。',
      examples: [
        'The balloon drifted upward.（气球向上飘去。）',
        'She looked upward at the stars.（她抬头仰望星空。）',
      ],
      synonyms: [
        { word: 'up', note: '向上，最简单的表达' },
        { word: 'skyward', note: '朝天空方向，更具诗意' },
      ],
    },
    {
      word: 'shaking',
      ...
      pos: 'verb (present participle of shake)',
      detail:
        'shake 指身体不由自主地抖动，通常因恐惧或寒冷。原文中黑水河神跪在地上浑身发抖（fell to his knees, shaking），因为他害怕悟空的武力。',
      examples: [
        'He was shaking with fear.（他吓得浑身发抖。）',
        'Her hands were shaking.（她的手在颤抖。）',
      ],
      synonyms: [
        { word: 'trembling', note: '颤抖，更持续、更细微' },
        { word: 'shivering', note: '哆嗦，多因寒冷' },
      ],
    },
    {
      word: 'mighty',
      ...
      pos: 'adjective',
      detail:
        'mighty 意为"强大的、强有力的"，比 powerful 更具文学色彩。原文中黑水河神说蜥蜴精的叔叔是东海强大的龙王（the mighty Dragon King of the Eastern Sea），强调龙王的权势和地位。',
      examples: [
        'A mighty river flowed through the valley.（一条大河穿过山谷。）',
        'He is a mighty warrior.（他是一位强大的战士。）',
      ],
      synonyms: [
        { word: 'powerful', note: '强大的，最普通用词' },
        { word: 'formidable', note: '令人敬畏的、难以对付的' },
      ],
    },
    {
      word: 'nephew',
      ...
      pos: 'noun',
      detail:
        'nephew 指兄弟或姐妹的儿子。原文中蜥蜴精是东海龙王的外甥（nephew），这也是蜥蜴精胆敢霸占黑水河的原因——他有强大的后台。',
      examples: [
        'My nephew just started school.（我的侄子刚入学。）',
        'She has two nephews and one niece.（她有两个侄子和一个侄女。）',
      ],
    },
    {
      ...
      pos: 'verb (past tense of fade)',
      detail:
        'fade 意为"逐渐消失、褪色"。原文中龙王的笑容消失了（The dragon\'s smile faded），因为他得知外甥惹了大祸。用 fade 形容笑容消失，比 disappeared 更生动，暗示表情的渐变过程。',
      examples: [
        'Her smile faded when she heard the news.（听到消息后她的笑容消失了。）',
        'The colors have faded over time.（颜色随着时间逐渐褪去。）',
      ],
      synonyms: [
        { word: 'disappeared', note: '消失，更直接' },
        { word: 'vanished', note: '突然消失，更彻底' },
      ],
    },
    {
      word: 'took over',
      ...
      pos: 'phrasal verb',
      detail:
        'take over 意为"接管、接手"。原文中蜥蜴精霸占了黑水河神的领地（took over the Black River），赶走了原来的河神，自己占山为王。',
      examples: [
        'The army took over the city.（军队接管了城市。）',
        'She took over the business from her father.（她从父亲手中接管了生意。）',
      ],
      synonyms: [
        { word: 'seized', note: '夺取，强调武力' },
        { word: 'occupied', note: '占领，更正式' },
      ],
    },
    {
      word: 'take care of it',
      phonetic: '/teɪk kɛr əv ɪt/',
      brief: '处理这件事，解决它',
      pos: 'phrase',
      detail:
        'take care of 意为"处理、照顾、解决"。原文中东海龙王听说外甥闯祸后说"我来处理"（I\'ll take care of it），表示他会亲自解决这个麻烦。',
      examples: [
        'Don\'t worry, I\'ll take care of it.（别担心，我来处理。）',
        'She took care of the problem quickly.（她迅速解决了问题。）',
      ],
      synonyms: [
        { word: 'handle it', note: '处理它，更正式' },
        { word: 'sort it out', note: '解决它，更口语化' },
      ],
    },
    {
      word: 'at once',
      ...
      pos: 'phrase',
      detail:
        'at once 意为"立刻、马上"，语气比 right now 更强烈。原文中龙王对蜥蜴精大喊"立刻从河里出来！"（Come out of that river at once!），命令的口吻非常强硬。',
      examples: [
        'Do it at once!（立刻去做！）',
        'She left the room at once.（她立刻离开了房间。）',
      ],
      synonyms: [
        { word: 'immediately', note: '立即，更正式' },
        { word: 'right away', note: '马上，更口语化' },
      ],
    },
    {
      word: 'gulped',
      phonetic: '/ɡʌlpt/',
      brief: '紧张地咽了口唾沫，倒吸一口气',
      pos: 'verb (past tense of gulp)',
      detail:
        'gulp 本意是"大口吞咽"。此处蜥蜴精听到叔叔要带他去玉帝那里受罚时紧张地咽了口唾沫（The lizard gulped），表现出他突然的恐惧。这个动作在文学中常用于表现害怕或紧张。',
      examples: [
        'He gulped nervously before speaking.（他紧张地咽了口唾沫才开口说话。）',
        'She gulped down the glass of water.（她大口喝下那杯水。）',
      ],
      synonyms: [
        { word: 'swallowed hard', note: '用力咽下，同样表示紧张' },
        { word: 'gasped', note: '倒吸气，更突然' },
      ],
    },
  ],
  book_10: [
  ...
  book_11: [
    {
      ...
      pos: 'noun',
      detail:
        'residence 指某人居住的地方，比 house 或 home 更正式。原文中\u201cResidence of the River Turtle\u201d是河龟住所门牌上的文字，用 residence 显得庄重正式。',
      examples: [
        'The president\u2019s residence is heavily guarded.（总统的住所戒备森严。）',
        'They moved into their new residence last week.（他们上周搬进了新住所。）',
      ],
      synonyms: [
        { word: 'dwelling', note: '住所，较文学化' },
        { word: 'house', note: '房屋，更口语化' },
      ],
    },
    {
      word: 'Turtle',
      ...
      pos: 'noun',
      detail:
        'turtle 是龟类的通称。在《西游记》中，通天河的老龟（River Turtle）驮唐僧过河，是经典的配角。turtle 在美式英语中泛指龟类，英式英语中特指海龟。',
      examples: [
        'The turtle slowly crossed the road.（乌龟慢慢地穿过了马路。）',
        'Sea turtles can live for over a hundred years.（海龟能活一百多年。）',
      ],
      synonyms: [
        { word: 'tortoise', note: '陆龟，生活在陆地上' },
      ],
    },
    {
      word: 'paced',
      phonetic: '/peɪst/',
      brief: '踱步，来回走动',
      pos: 'verb (past tense of pace)',
      detail:
        'pace 作动词指因焦虑、紧张或思考而来回走动。原文中悟空在冰面上 paced back and forth（来回踱步），表现出他对师父被抓的焦急和不安。',
      examples: [
        'He paced the room, thinking about what to do.（他在房间里踱来踱去，想着该怎么办。）',
        'She paced up and down the hallway, waiting for the results.（她在走廊里来回踱步，等待结果。）',
      ],
      synonyms: [
        { word: 'walked back and forth', note: '来回走动，更直白' },
        { word: 'strode', note: '大步走，强调步态而非焦虑' },
      ],
    },
    {
      word: 'pacing',
      phonetic: '/ˈpeɪsɪŋ/',
      brief: '踱步（现在分词）',
      pos: 'verb (present participle of pace)',
      detail:
        'pacing 是 pace 的现在分词形式。原文中 Wukong stopped pacing（悟空停止了踱步），pacing 在这里作名词使用，指踱步这个动作。',
      examples: [
        'His constant pacing was making me nervous.（他不停地踱步让我紧张。）',
        'She continued pacing around the room.（她继续在房间里踱步。）',
      ],
      synonyms: [
        { word: 'walking about', note: '走来走去，语气更随意' },
      ],
    },
    {
      word: 'Cowards',
      phonetic: '/ˈkaʊərdz/',
      brief: '胆小鬼，懦夫',
      pos: 'noun (plural of coward)',
      detail:
        'coward 指胆小怕事的人，复数形式 cowards 常用作侮辱性称呼。原文中妖怪追击八戒和沙僧时喊\u201cCowards!\u201d（胆小鬼们！），是在嘲笑他们逃跑。',
      examples: [
        'Only a coward would run away from a fight.（只有懦夫才会临阵脱逃。）',
        'They called him a coward for not standing up to the bully.（他们因为他不敢对抗恶霸而叫他胆小鬼。）',
      ],
      synonyms: [
        { word: 'chicken', note: '胆小鬼，口语化' },
      ],
    },
    {
      word: 'surface',
      ...
      pos: 'noun',
      detail:
        'surface 指物体的表面或水/地的表层。原文中妖怪追着八戒他们 toward the surface（朝水面方向），指从水底游向水面。surface 也可作动词，表示浮出水面。',
      examples: [
        'The fish rose to the surface of the water.（鱼浮到了水面。）',
        'The surface of the lake was perfectly still.（湖面平静如镜。）',
      ],
      synonyms: [
        { word: 'top', note: '顶部，更口语化' },
      ],
    },
    {
      word: 'ducked',
      ...
      pos: 'verb (past tense of duck)',
      detail:
        'duck 作动词指迅速低头或弯腰以躲避某物。原文中妖怪 ducked（低头躲避）悟空挥来的铁棒，是一个瞬间的闪避动作。duck 比 dodge 更强调\u201c低头弯腰\u201d的身体动作。',
      examples: [
        'He ducked just in time to avoid the flying ball.（他及时低头躲过了飞来的球。）',
        'She ducked under the low branch.（她弯腰躲过低矮的树枝。）',
      ],
      synonyms: [
        { word: 'dodged', note: '闪避，更强调移动身体躲开' },
        { word: 'bent down', note: '弯下腰，单纯描述动作' },
      ],
    },
    {
      word: 'formed',
      phonetic: '/fɔːrmd/',
      brief: '形成，出现',
      pos: 'verb (past tense of form)',
      detail:
        'form 作动词指形成、产生。原文中 More cracks formed in the ice（冰面上形成了更多裂缝），cracks 是主语，formed 表示裂缝自然出现。form 强调从无到有的形成过程。',
      examples: [
        'Ice crystals formed on the window.（窗户上结了冰晶。）',
        'A crowd formed around the street performer.（人群聚集在街头艺人周围。）',
      ],
      synonyms: [
        { word: 'appeared', note: '出现，更强调可见性' },
        { word: 'developed', note: '发展形成，强调过程' },
      ],
    },
    {
      word: 'slammed',
      ...
      pos: 'verb (past tense of slam)',
      detail:
        'slam 指用力猛击或砰地关上。原文中出现两次：第一次是八戒滑过冰面 slammed into Wujing（猛地撞上沙僧）；第二次是妖怪 slammed the door shut（砰地把门关上）。slam 强调动作的猛烈和巨大的声响。',
      examples: [
        'She slammed the door in his face.（她当着他的面砰地关上门。）',
        'The car slammed into a tree.（汽车猛地撞上了一棵树。）',
      ],
      synonyms: [
        { word: 'crashed', note: '撞击，更强调破坏性' },
        { word: 'banged', note: '猛敲，侧重发出响声' },
      ],
    },
    {
      word: 'pile',
      ...
      pos: 'noun',
      detail:
        'pile 指一堆堆放在一起的物品。原文中他们在水底宫殿门前发现 a huge pile of rocks（一大堆石头），用 pile 形象地描写了妖怪用巨石堆封门的场景。',
      examples: [
        'There was a pile of books on the desk.（桌上有一堆书。）',
        'He swept the leaves into a pile.（他把落叶扫成一堆。）',
      ],
      synonyms: [
        { word: 'heap', note: '堆，语气更随意，暗示杂乱' },
        { word: 'stack', note: '整齐堆叠的一摞' },
      ],
    },
    {
      word: 'held',
      phonetic: '/hɛld/',
      brief: '固定住，保持在原位',
      pos: 'verb (past participle of hold)',
      detail:
        'hold 的过去分词 held 在此处表示被固定住、保持不动。原文中沙僧猜测石头 held in place with magic（被法术固定在原位），held in place 是固定搭配，意思是牢牢固定、不移动。',
      examples: [
        'The sign was held in place by two nails.（牌子被两颗钉子固定着。）',
        'She held the door open for him.（她替他拉着门。）',
      ],
      synonyms: [
        { word: 'secured', note: '固定，更强调牢固' },
        { word: 'fastened', note: '系紧、扣牢' },
      ],
    },
    {
      word: 'puzzled',
      ...
      pos: 'adjective',
      detail:
        'puzzled 指因不理解而感到困惑。原文中悟空遇到红孩儿时 was puzzled（感到困惑），因为他没认出眼前这个善良的年轻人就是曾经那个邪恶的妖怪。puzzled 比 confused 程度稍轻，更像是想不通。',
      examples: [
        'She looked puzzled by the question.（她看起来被这个问题弄糊涂了。）',
        'I was puzzled by his behavior.（我对他的行为感到困惑。）',
      ],
      synonyms: [
        { word: 'confused', note: '困惑的，程度稍重，带有茫然感' },
        { word: 'bewildered', note: '非常困惑，程度更强' },
      ],
    },
    {
      word: 'A look of',
      ...
      pos: 'phrase',
      detail:
        'a look of + 情绪名词，表示脸上呈现出某种表情。原文中 A look of confusion spread across the monkey\u2019s face（困惑的表情在猴子脸上蔓延开来），这是一个描写表情变化的经典句式。',
      examples: [
        'A look of surprise crossed her face.（惊讶的表情掠过她的脸庞。）',
        'A look of relief came over him.（他脸上露出了如释重负的表情。）',
      ],
      synonyms: [
        { word: 'an expression of', note: '更正式的\u2026的表情表达' },
      ],
    },
    {
      word: 'spread',
      ...
      pos: 'verb',
      detail:
        'spread 指从一点向四周蔓延、扩散。原文中 confusion spread across the monkey\u2019s face（困惑在他脸上蔓延开来），用 spread 生动描写了表情从局部逐渐布满整张脸的过程。spread 的过去式和过去分词都是 spread。',
      examples: [
        'The fire spread quickly through the building.（大火迅速蔓延了整栋建筑。）',
        'A smile spread across her face.（笑容在她脸上绽开。）',
      ],
      synonyms: [
        { word: 'crept', note: '悄悄蔓延，速度较慢' },
        { word: 'covered', note: '覆盖，不强调蔓延过程' },
      ],
    },
    {
      word: 'flopping',
      phonetic: '/ˈflɑːpɪŋ/',
      brief: '扑腾，（无力地）跳动',
      pos: 'verb (present participle of flop)',
      detail:
        'flop 指笨拙地、无力地跳动或挣扎。原文中小金鱼在篮子里 flopping around（扑腾着），描写鱼离开水后无力的蹦跳。flop 强调笨拙和无力，不像 jump 那样有力量。',
      examples: [
        'The fish was flopping on the deck.（鱼在甲板上扑腾。）',
        'He flopped onto the sofa, exhausted.（他疲惫地瘫倒在沙发上。）',
      ],
      synonyms: [
        { word: 'floundering', note: '在困境中挣扎' },
        { word: 'thrashing', note: '剧烈扭动，力度更大' },
      ],
    },
    {
      word: 'lotus',
      ...
      pos: 'noun',
      detail:
        'lotus 指莲花，在佛教文化中象征纯洁和觉悟。原文中观音说金鱼住在她的 lotus pond（莲花池）中。莲花出淤泥而不染，是佛教中非常重要的象征。',
      examples: [
        'Lotus flowers bloom in the summer.（莲花在夏天盛开。）',
        'The lotus is a symbol of purity in Buddhism.（莲花在佛教中是纯洁的象征。）',
      ],
      synonyms: [
        { word: 'water lily', note: '睡莲，外形相似但品种不同' },
      ],
    },
    {
      word: 'chopping',
      phonetic: '/ˈtʃɑːpɪŋ/',
      brief: '砍，劈',
      pos: 'verb (present participle of chop)',
      detail:
        'chop 指用斧头或刀具用力砍、劈。原文中村民们 chopping down trees（砍树）是为了给取经团队造船。chop 强调一下一下地砍，比 cut 更有力。',
      examples: [
        'He was chopping wood for the fire.（他在劈柴生火。）',
        'They chopped down the old tree.（他们砍倒了那棵老树。）',
      ],
      synonyms: [
        { word: 'hacking', note: '乱砍，更粗暴' },
        { word: 'cutting', note: '切割，更通用' },
      ],
    },
    {
      word: 'scene',
      ...
      pos: 'noun',
      detail:
        'scene 指眼前呈现的场景、景象。原文中 a very busy scene（一个非常忙碌的场景）描写了村民们在河边热火朝天造船的画面。scene 强调视觉上呈现出的整体画面。',
      examples: [
        'The scene at the market was chaotic.（市场里的场面一片混乱。）',
        'It was a scene of total destruction.（那是一幅彻底毁坏的景象。）',
      ],
      synonyms: [
        { word: 'sight', note: '景象，侧重看到的画面' },
        { word: 'spectacle', note: '壮观场面，更强调视觉冲击' },
      ],
    },
    {
      word: 'shore',
      ...
      pos: 'noun',
      detail:
        'shore 指水边的陆地、岸边。原文中浪花拍打 onto the shore（拍上岸边），以及后来乌龟远离 shore（岸边）。shore 特指水体与陆地交界的地方。',
      examples: [
        'We walked along the shore of the lake.（我们沿着湖岸散步。）',
        'The boat drifted toward the shore.（小船漂向岸边。）',
      ],
      synonyms: [
        { word: 'bank', note: '河岸，多指河流两侧' },
        { word: 'coast', note: '海岸，指更大的范围' },
      ],
    },
    {
      word: 'bowed',
      phonetic: '/baʊd/',
      brief: '低头，鞠躬',
      pos: 'verb (past tense of bow)',
      detail:
        'bow 作动词指低头或弯腰表示敬意。原文中老龟 bowed its head toward Wukong（向悟空低头致意），这是一个表示尊重和感谢的姿态。注意 bow 作鞠躬时读 /baʊ/，作弓时读 /boʊ/。',
      examples: [
        'He bowed before the king.（他在国王面前鞠躬。）',
        'She bowed her head in prayer.（她低头祈祷。）',
      ],
      synonyms: [
        { word: 'nodded', note: '点头，幅度更小' },
        { word: 'bent', note: '弯曲，物理动作更中性' },
      ],
    },
    {
      word: 'taken over',
      phonetic: '/ˈteɪkən ˈoʊvər/',
      brief: '霸占，接管',
      pos: 'phrasal verb (past participle of take over)',
      detail:
        'take over 指接管、夺取控制权。原文中老龟说妖怪 had taken over my house and river（霸占了我的房子和河流），take over 在此带有强占的意味，不是合法的接管。',
      examples: [
        'The army took over the government.（军队接管了政府。）',
        'She took over the business after her father retired.（她在父亲退休后接管了生意。）',
      ],
      synonyms: [
        { word: 'seized', note: '夺取，更强调暴力' },
        { word: 'occupied', note: '占据，更中性' },
      ],
    },
    {
      word: 'eyed',
      ...
      pos: 'verb (past tense of eye)',
      detail:
        'eye 作动词指用目光打量、审视某人或某物。原文中悟空 eyed the turtle suspiciously（用怀疑的目光打量老龟），把 eye 用作动词，生动描写了悟空警惕地观察的神态。',
      examples: [
        'She eyed the cake on the table.（她盯着桌上的蛋糕看。）',
        'He eyed me suspiciously.（他怀疑地打量着我。）',
      ],
      synonyms: [
        { word: 'watched', note: '注视，更持续' },
        { word: 'examined', note: '仔细检查，更正式' },
      ],
    },
    {
      word: 'suspiciously',
      ...
      pos: 'adverb',
      detail:
        'suspiciously 指带着怀疑的态度。原文中悟空 eyed the turtle suspiciously（怀疑地打量老龟），因为他一路上遇到过太多妖怪伪装成好人来欺骗他们。',
      examples: [
        'The guard looked at him suspiciously.（警卫怀疑地看着他。）',
        'She eyed the stranger suspiciously.（她用怀疑的目光打量陌生人。）',
      ],
      synonyms: [
        { word: 'doubtfully', note: '疑惑地，偏向不确定' },
        { word: 'warily', note: '警惕地，偏向小心防备' },
      ],
    },
    {
      word: 'paddle',
      ...
      pos: 'verb',
      detail:
        'paddle 指用短桨划水，或像鸭子、乌龟那样用脚蹼划水前进。原文中老龟 began to paddle（开始划水），描写老龟用四肢划水前进的动作。',
      examples: [
        'They paddled the canoe across the lake.（他们划着独木舟穿过湖面。）',
        'The duck paddled in the pond.（鸭子在池塘里划水。）',
      ],
      synonyms: [
        { word: 'rowed', note: '划船，使用船桨' },
        { word: 'swam', note: '游泳，更通用的水中移动' },
      ],
    },
    {
      word: 'on your way home',
      phonetic: '/ɑːn jər weɪ hoʊm/',
      brief: '在回家的路上',
      pos: 'phrase',
      detail:
        'on one\u2019s way home 意思是在回家的路上。原文中村民喊道 visit us on your way home!（回家的时候来看我们！），因为他们知道取经团队最终会原路返回。',
      examples: [
        'I\u2019ll pick up some milk on my way home.（我回家的路上买点牛奶。）',
        'We stopped at a caf\u00e9 on our way home.（我们在回家路上去了一家咖啡馆。）',
      ],
      synonyms: [
        { word: 'on the way back', note: '在回去的路上，更通用' },
      ],
    },
    {
      word: 'glanced',
      ...
      pos: 'verb (past tense of glance)',
      detail:
        'glance 指快速地看一眼，不像 stare 那样长时间注视。原文中老龟 glanced back at the Tang Monk（回头瞥了唐僧一眼），描写了老龟想开口请求但又有些犹豫的神态。',
      examples: [
        'She glanced at her watch.（她瞥了一眼手表。）',
        'He glanced up from his book.（他从书本上抬起头瞥了一眼。）',
      ],
      synonyms: [
        { word: 'peeked', note: '偷看，更快速隐蔽' },
        { word: 'stared', note: '凝视，长时间注视，与 glance 相反' },
      ],
    },
    {
      word: 'favor',
      ...
      pos: 'noun',
      detail:
        'favor 指请人帮忙或给予的恩惠。原文中老龟请求唐僧 can you do me a favor?（你能帮我一个忙吗？），是英语中请求帮助的常见委婉说法。do someone a favor 是固定搭配。',
      examples: [
        'Can you do me a favor and close the door?（你能帮我关一下门吗？）',
        'She asked me a big favor.（她请我帮一个大忙。）',
      ],
      synonyms: [
        { word: 'help', note: '帮助，更通用' },
        { word: 'kindness', note: '善意，善举' },
      ],
    },
    {
      ...
      pos: 'adverb',
      detail:
        'already 指某事发生得比预期更早。原文中八戒抱怨 I\u2019m tired of walking already（我已经走累了），already 在句末强调不耐烦。already 放句末时语气更口语化、更带抱怨。',
      examples: [
        'Is it 5 o\u2019clock already?（已经5点了吗？）',
        'I\u2019m bored already.（我已经觉得无聊了。）',
      ],
      synonyms: [
        { word: 'by now', note: '到这时，强调时间点' },
      ],
    },
    {
      word: 'moaned',
      ...
      pos: 'verb (past tense of moan)',
      detail:
        'moan 指发出低沉的声音表示痛苦或不满。原文中八戒 moaned 抱怨路不平了，这是他惯常的抱怨方式。moan 比 groan 更多用于表达不满和怨言。',
      examples: [
        'He moaned about having to get up early.（他抱怨要早起。）',
        'The patient moaned in pain.（病人痛苦地呻吟。）',
      ],
    ...
    },
    {
      ...
      phonetic: '/ˈʃɪvərd/',
      brief: '发抖，打哆嗦',
      pos: 'verb (past tense of shiver)',
      detail:
        'shiver 指因寒冷或恐惧而身体发抖。原文中沙僧 shivered（冻得发抖），因为山上的寒风吹来。shiver 多用于因寒冷引起的发抖，而 tremble 多用于因恐惧引起的发抖。',
      examples: [
        'She shivered in the cold wind.（她在寒风中冻得发抖。）',
        'He shivered at the thought of the ghost.（一想到鬼他就打了个哆嗦。）',
      ],
      synonyms: [
        { word: 'trembled', note: '发抖，多因恐惧' },
        { word: 'quivered', note: '微微颤抖' },
      ],
    },
    {
      ...
      pos: 'adverb',
      detail:
        'sharply 指说话或动作尖锐、严厉。原文中悟空 sharply（严厉地）告诉同伴待在原地不要去寺院，表现出他作为团队领袖的果断和警惕。',
      examples: [
        'She said sharply, \u201cDon\u2019t do that!\u201d（她严厉地说：\u201c别那样做！\u201d）',
        'He spoke sharply to the children.（他对孩子们说话很严厉。）',
      ],
      synonyms: [
        { word: 'sternly', note: '严厉地，更强调态度严肃' },
        { word: 'strictly', note: '严格地，偏向规则层面' },
      ],
    },
    {
      word: 'stroked',
      phonetic: '/stroʊkt/',
      brief: '抚摸，摸着',
      pos: 'verb (past tense of stroke)',
      detail:
        'stroke 指用手轻轻抚摸。原文中沙僧 stroked his chin（摸了摸下巴），这是一个表示思考、犹豫的肢体语言。英语文学中 stroking one\u2019s chin 常表示在思考。',
      examples: [
        'She stroked the cat\u2019s fur.（她抚摸猫的毛。）',
        'He stroked his beard thoughtfully.（他若有所思地捋着胡须。）',
      ],
      synonyms: [
        { word: 'rubbed', note: '揉搓，力度更大' },
        { word: 'caressed', note: '温柔地抚摸，带有感情色彩' },
      ],
    },
    {
      word: 'though',
      ...
      pos: 'adverb',
      detail:
        'though 在此处作副词放在句末，意思是不过、然而，相当于 however。原文中沙僧说 Wukong believed it though（不过悟空相信了），用 though 来表达转折。though 放句末是口语中非常常见的用法。',
      examples: [
        'It was hard work. I enjoyed it though.（工作很辛苦。不过我很享受。）',
        'I don\u2019t agree. I understand your point though.（我不同意。不过我理解你的观点。）',
      ],
      synonyms: [
        { word: 'however', note: '然而，更正式，通常不放句末' },
        { word: 'anyway', note: '无论如何，偏向不管怎样' },
      ],
    },
    {
      word: 'bump into',
      phonetic: '/bʌmp ˈɪntuː/',
      brief: '碰见，撞上',
      pos: 'phrasal verb',
      detail:
        'bump into 字面意思是撞上，引申为偶然碰见。原文中八戒说 we\u2019ll bump into a demon（我们会撞上妖怪），用的是字面义的夸张说法。',
      examples: [
        'I bumped into an old friend at the store.（我在商店碰见了一位老朋友。）',
        'Be careful not to bump into the table.（小心别撞到桌子。）',
      ],
      synonyms: [
        { word: 'run into', note: '碰见、撞上，用法相似' },
        { word: 'encounter', note: '遭遇，更正式' },
      ],
    },
    {
      word: 'perfectly',
      ...
      pos: 'adverb',
      detail:
        'perfectly 在此处不是完美地，而是完全地、十分，用来加强语气。原文中沙僧说 That place looks perfectly safe（那个地方看起来十分安全），perfectly safe 是常见搭配，意思是非常安全。',
      examples: [
        'It\u2019s perfectly normal to feel nervous.（感到紧张是完全正常的。）',
        'She speaks English perfectly well.（她英语说得非常好。）',
      ],
      synonyms: [
        { word: 'absolutely', note: '绝对地，强调确信' },
        { word: 'completely', note: '完全地，更中性' },
      ],
    },
    {
      word: 'settles',
      phonetic: '/ˈsɛtlz/',
      brief: '决定了，就这么定了',
      pos: 'verb (third person singular of settle)',
      detail:
        'settle 在此处意思是决定、解决。原文中八戒说 That settles it（就这么定了），这是英语中的固定表达，意思是这件事就这样决定了，不必再讨论。',
      examples: [
        'That settles it \u2014 we\u2019re going to the beach!（就这么定了\u2014\u2014我们去海滩！）',
        'The rain settles it. We\u2019re staying home.（下雨了，就这么定了，我们待在家里。）',
      ],
      synonyms: [
        { word: 'decides', note: '决定，更通用' },
      ],
    },
    {
      word: 'deserted',
      ...
      pos: 'adjective',
      detail:
        'deserted 指曾经有人但现在空无一人的、被废弃的。原文中沙僧说 This place is deserted（这里荒废了），走进寺院后发现里面空荡荡的。deserted 带有诡异的氛围感。',
      examples: [
        'The village was completely deserted.（村庄完全荒废了。）',
        'We walked through the deserted streets at night.（我们在夜晚空无一人的街道上行走。）',
      ],
      synonyms: [
        { word: 'abandoned', note: '被遗弃的，更强调主动抛弃' },
        { word: 'empty', note: '空的，更中性' },
      ],
    },
    {
      word: 'boiling',
      phonetic: '/ˈbɔɪlɪŋ/',
      brief: '沸腾的，煮着的',
      pos: 'verb / adjective (present participle of boil)',
      detail:
        'boiling 原意指水烧开沸腾。原文中八戒想象 With noodles boiling and vegetables sizzling（面条翻滚着，蔬菜嗞嗞作响），用 boiling 和 sizzling 两个感官词描绘出热闹的厨房场景。',
      examples: [
        'The water is boiling.（水烧开了。）',
        'She was boiling pasta for dinner.（她在煮意面当晚餐。）',
      ],
      synonyms: [
        { word: 'simmering', note: '慢炖着，温度更低' },
        { word: 'bubbling', note: '冒着泡' },
      ],
    },
    {
      word: 'growled',
      ...
      pos: 'verb (past tense of growl)',
      detail:
        'growl 原指动物低沉的咆哮声，也常用于形容肚子饿时发出的咕噜声。原文中八戒的肚子 growled again（又叫了），用 growl 幽默地描写了饥饿的肚子发出的响声。',
      examples: [
        'The dog growled at the stranger.（狗对着陌生人低吼。）',
        'His stomach growled during the meeting.（开会时他的肚子咕咕叫。）',
      ],
      synonyms: [
        { word: 'rumbled', note: '发出隆隆声，形容肚子更常用' },
        { word: 'grumbled', note: '嘟囔抱怨，用于人' },
      ],
    },
    {
      word: 'silk vests',
      ...
      pos: 'noun phrase',
      detail:
        'silk vest 指丝绸做的背心/马甲。原文中桌上摆着三件 silk vests（丝绸背心），实际上是妖怪设下的陷阱。vest 在英式英语中指内衣背心，美式英语中指马甲。',
      examples: [
        'He wore a silk vest under his jacket.（他在夹克里面穿了一件丝绸背心。）',
      ],
      synonyms: [
        { word: 'waistcoat', note: '马甲（英式英语）' },
      ],
    },
    {
      word: 'magnificent',
      ...
      pos: 'adjective',
      detail:
        'magnificent 指极其华丽、壮观的，令人赞叹的。原文中八戒看到丝绸背心后说 They look magnificent（看起来好华丽），表现出他贪婪的本性。magnificent 比 beautiful 更强调壮丽和气势。',
      examples: [
        'The palace was absolutely magnificent.（宫殿极其壮丽。）',
        'She wore a magnificent gown to the ball.（她穿了一件华丽的礼服去参加舞会。）',
      ],
      synonyms: [
        { word: 'splendid', note: '辉煌的，带有赞美的语气' },
        { word: 'gorgeous', note: '极美的，更口语化' },
      ],
    },
    {
      word: 'vests',
      phonetic: '/vɛsts/',
      brief: '背心，马甲（复数）',
      pos: 'noun (plural of vest)',
      detail:
        'vest 的复数形式。原文中八戒偷了三件 vests，这些背心实际上是妖怪的陷阱法宝，穿上就脱不下来。',
      examples: [
        'The store sells vests in many colors.（这家店卖各种颜色的背心。）',
      ],
      synonyms: [
        { word: 'waistcoats', note: '马甲（英式英语）' },
      ],
    },
    {
      word: 'vest',
      ...
      pos: 'noun',
      detail:
        'vest 指无袖的上衣、背心或马甲。原文中多次出现 vest，八戒和沙僧各穿了一件 vest，结果被紧紧箍住脱不下来。vest 在本书中是关键道具。',
      examples: [
        'He put on a warm vest under his shirt.（他在衬衫里面穿了一件保暖背心。）',
        'She bought a leather vest.（她买了一件皮马甲。）',
      ],
      synonyms: [
        { word: 'waistcoat', note: '马甲（英式英语）' },
      ],
    },
    {
      ...
      pos: 'verb (past tense of glare)',
      detail:
        'glare 指愤怒地盯着某人看。原文中出现两次：第一次是唐僧 glared at Bajie（怒视八戒），因为八戒偷了背心；第二次是妖怪 glared at Wukong（怒视悟空），表示挑衅和不屑。',
      examples: [
        'She glared at him angrily.（她愤怒地瞪着他。）',
        'The teacher glared at the noisy students.（老师怒视着吵闹的学生。）',
      ],
    ...
    },
    {
      ...
      phonetic: '/ˈɔːfərd/',
      brief: '提议，主动提出',
      pos: 'verb (past tense of offer)',
      detail:
        'offer 指主动提出建议或帮助。原文中沙僧 offered（提议说）可以在离开前归还背心，用 offer 表示他主动提出一个折中方案。',
      examples: [
        'She offered to help me with my homework.（她主动提出帮我做作业。）',
        'He offered a solution to the problem.（他提出了一个解决问题的方案。）',
      ],
      synonyms: [
        { word: 'suggested', note: '建议，偏向想法而非行动' },
        { word: 'proposed', note: '提议，更正式' },
      ],
    },
    {
      word: 'shrugged',
      ...
      pos: 'verb (past tense of shrug)',
      detail:
        'shrug 指耸肩，表示无所谓、随便。原文中八戒 shrugged（耸了耸肩），表现出他对师父批评的不在乎态度。shrug 是英语中非常常见的肢体语言。',
      examples: [
        'He shrugged and said he didn\u2019t care.（他耸耸肩说不在乎。）',
        'She shrugged off the criticism.（她对批评满不在乎。）',
      ],
      synonyms: [
        { word: 'dismissed', note: '不予理会，更正式' },
      ],
    },
    {
      ...
      phonetic: '/ˈbʌtnɪŋ/',
      brief: '扣纽扣',
      pos: 'verb (present participle of button)',
      detail:
        'button 作动词指扣上纽扣。原文中沙僧 began buttoning his vest（开始扣背心的纽扣），就在这时背心突然收紧，困住了他们。',
      examples: [
        'She was buttoning her coat.（她在扣大衣的纽扣。）',
        'He buttoned up his shirt.（他扣好了衬衫。）',
      ],
      synonyms: [
        { word: 'fastening', note: '系紧、扣紧，更通用' },
      ],
    },
    {
      word: 'desperately',
      phonetic: '/ˈdɛspərətli/',
      brief: '拼命地，绝望地',
      pos: 'adverb',
      detail:
        'desperately 指不顾一切地、拼命地做某事。原文中八戒和沙僧 trying desperately to take the vests off（拼命想把背心脱下来），desperately 强调了他们极度焦急、不顾一切的状态。',
      examples: [
        'They searched desperately for the missing child.（他们拼命寻找失踪的孩子。）',
        'She was desperately trying to stay awake.（她拼命想保持清醒。）',
      ],
      synonyms: [
        { word: 'frantically', note: '疯狂地、慌乱地' },
        { word: 'urgently', note: '紧急地，偏向时间紧迫' },
      ],
    },
    {
      word: 'clasped',
      phonetic: '/klæspt/',
      brief: '紧握，合拢（双手）',
      pos: 'verb (past tense of clasp)',
      detail:
        'clasp 指紧紧握住或合拢双手。原文中妖怪 clasped his hands together（双手合拢），这是一个表示激动或得意的动作。',
      examples: [
        'She clasped her hands in excitement.（她激动地紧握双手。）',
        'He clasped the child tightly.（他紧紧地抱住孩子。）',
      ],
      synonyms: [
        { word: 'grasped', note: '抓紧，偏向用力握住某物' },
      ],
    },
    {
      word: 'smirked',
      ...
      pos: 'verb (past tense of smirk)',
      detail:
        'smirk 指得意洋洋的、有些轻蔑的笑。原文中独角犀牛 smirked（得意地笑），因为他觉得自己比悟空的朋友厉害。smirk 带有负面的含义\u2014\u2014自以为是、瞧不起别人。',
      examples: [
        'He smirked when he heard the news.（他听到消息后得意地笑了。）',
        'She smirked at his mistake.（她对他的错误露出得意的笑容。）',
      ],
      synonyms: [
        { word: 'sneered', note: '嗤笑，更带有轻蔑' },
        { word: 'grinned', note: '咧嘴笑，中性词' },
      ],
    },
    {
      word: 'smirk',
      ...
      pos: 'noun',
      detail:
        'smirk 作名词指得意洋洋的笑容。原文中 The demon\u2019s smirk disappeared（妖怪得意的笑容消失了），因为听说对手是孙悟空后害怕了。smirk 从出现到消失，生动展现了妖怪从傲慢到惊慌的心理转变。',
      examples: [
        'He had a smirk on his face.（他脸上挂着得意的笑容。）',
        'Her smirk turned into a frown.（她的得意之笑变成了皱眉。）',
      ],
      synonyms: [
        { word: 'sneer', note: '冷笑，更带有嘲讽' },
      ],
    },
    {
      word: 'stood taller',
      phonetic: '/stʊd ˈtɔːlər/',
      brief: '挺直身子，挺起胸膛',
      pos: 'phrase',
      detail:
        'stand taller 字面意思是站得更直，比喻摆出强硬姿态、故作勇敢。原文中妖怪 stood taller（挺直了身子），说才不怕他呢，但其实内心是害怕的，stand taller 描写了虚张声势的姿态。',
      examples: [
        'He stood taller and faced the crowd.（他挺直身子面对人群。）',
        'She stood taller when the teacher praised her.（老师表扬她时她挺起了胸膛。）',
      ],
      synonyms: [
        { word: 'puffed up', note: '挺起胸膛，更口语化' },
        { word: 'straightened up', note: '站直，更中性' },
      ],
    },
    {
      word: 'revealing',
      phonetic: '/rɪˈviːlɪŋ/',
      brief: '露出，展示出',
      pos: 'verb (present participle of reveal)',
      detail:
        'reveal 指展示、揭露隐藏的东西。原文中妖怪 lifted his sleeve, revealing a metal ring（卷起袖子，露出一枚金属环），revealing 作伴随状语。',
      examples: [
        'She opened the box, revealing a beautiful necklace.（她打开盒子，露出一条美丽的项链。）',
        'The investigation revealed the truth.（调查揭示了真相。）',
      ],
      synonyms: [
        { word: 'exposing', note: '暴露，更强调被隐藏的东西' },
        { word: 'uncovering', note: '揭开，偏向物理上的揭开' },
      ],
    },
    {
      word: 'illusion',
      ...
      pos: 'noun',
      detail:
        'illusion 指看起来真实但实际上不存在的幻象。原文中悟空说 That monastery was an illusion（那座寺院是幻象），妖怪用法术制造出寺院的假象来引诱取经团队。',
      examples: [
        'The mirror created an optical illusion.（镜子制造了视觉错觉。）',
        'He was under the illusion that she loved him.（他幻想她爱着他。）',
      ],
      synonyms: [
        { word: 'mirage', note: '海市蜃楼，更具体' },
        { word: 'hallucination', note: '幻觉，偏向精神层面' },
      ],
    },
    {
      word: 'rubble',
      ...
      pos: 'noun',
      detail:
        'rubble 指建筑或岩石破碎后形成的碎石瓦砾。原文中悟空威胁要 turn this entire mountain into a pile of rubble（把整座山变成一堆碎石），展现了悟空的气势。',
      examples: [
        'The building was reduced to rubble after the earthquake.（地震后大楼变成了一片废墟。）',
        'They cleared the rubble from the road.（他们清理了路上的碎石。）',
      ],
      synonyms: [
        { word: 'debris', note: '碎片，残骸，更通用' },
        { word: 'wreckage', note: '残骸，多用于事故现场' },
      ],
    },
    {
      word: 'criminals',
      ...
      pos: 'noun (plural of criminal)',
      detail:
        'criminal 指犯下罪行的人。原文中妖怪称八戒他们是 criminals（罪犯），因为他们偷了背心。但妖怪故意忽略了自己用幻象引诱他们的阴谋。',
      examples: [
        'The police arrested the criminals.（警察逮捕了罪犯。）',
        'He was treated like a criminal.（他被当作罪犯对待。）',
      ],
      synonyms: [
        { word: 'thieves', note: '小偷，更具体' },
        { word: 'offenders', note: '违法者，更正式' },
      ],
    },
    {
      word: 'suggest',
      ...
      pos: 'verb',
      detail:
        'suggest 此处意思是暗示、有\u2026的意思。原文中悟空说 I can\u2019t believe you would even suggest---（真不敢相信你竟然暗示\u2014\u2014），suggest 在这里不是建议，而是暗示某件不好的事。',
      examples: [
        'Are you suggesting that I\u2019m lying?（你是在暗示我在说谎吗？）',
        'His silence suggested that he agreed.（他的沉默暗示他同意了。）',
      ],
      synonyms: [
        { word: 'imply', note: '暗示，更侧重含义上的暗示' },
        { word: 'propose', note: '提议，更正式的建议' },
      ],
    },
    {
      word: 'dodged',
      phonetic: '/ˈdɑːdʒd/',
      brief: '闪避，躲开',
      pos: 'verb (past tense of dodge)',
      detail:
        'dodge 指快速闪开以躲避攻击。原文中妖怪 dodged the bar（闪开了铁棒），描写了战斗中灵巧的躲避动作。dodge 比 duck 更强调横向移动的闪避。',
      examples: [
        'He dodged the ball just in time.（他及时躲开了球。）',
        'She dodged the question by changing the subject.（她通过转移话题回避了那个问题。）',
      ],
      synonyms: [
        { word: 'evaded', note: '规避，更正式' },
        { word: 'ducked', note: '低头躲避，动作不同' },
      ],
    },
    {
      word: 'slope',
      ...
      pos: 'noun',
      detail:
        'slope 指倾斜的地面或山坡。原文中 rocks tumbled down the mountain\u2019s slope（石头从山坡上滚落），slope 形象地描写了山的倾斜面。',
      examples: [
        'The house was built on a gentle slope.（房子建在一个缓坡上。）',
        'We skied down the steep slope.（我们从陡坡上滑下来。）',
      ],
      synonyms: [
        { word: 'hillside', note: '山坡，更通用' },
        { word: 'incline', note: '斜面，更正式' },
      ],
    },
    {
      word: 'rushed',
      ...
      pos: 'verb (past tense of rush)',
      detail:
        'rush 指快速、猛烈地向某处冲去。原文中妖怪 rushed at Wukong（朝悟空冲过去），描写了战斗中主动进攻的姿态。rush 比 run 更强调速度和猛烈程度。',
      examples: [
        'He rushed toward the exit.（他冲向出口。）',
        'The bull rushed at the matador.（公牛朝斗牛士冲去。）',
      ],
      synonyms: [
        { word: 'charged', note: '猛冲，带有攻击性' },
        { word: 'dashed', note: '飞奔，更强调速度' },
      ],
    },
    {
      word: 'rubbing',
      phonetic: '/ˈrʌbɪŋ/',
      brief: '揉搓，揉着',
      pos: 'verb (present participle of rub)',
      detail:
        'rub 指用手来回摩擦某处。原文中妖怪 rubbing his arm（揉着胳膊），因为被悟空的铁棒打中了。rubbing hurt body parts 是受伤后的本能反应。',
      examples: [
        'She was rubbing her tired eyes.（她揉着疲惫的眼睛。）',
        'He rubbed his sore shoulder.（他揉着酸痛的肩膀。）',
      ],
      synonyms: [
        { word: 'massaging', note: '按摩，力度更柔和' },
      ],
    },
    {
      word: 'extremely',
      ...
      pos: 'adverb',
      detail:
        'extremely 指程度极高地、非常。原文中悟空说 It\u2019s extremely heavy（它极其沉重），强调金箍棒的重量非同一般。extremely 是 very 的加强版。',
      examples: [
        'It was extremely cold outside.（外面极其寒冷。）',
        'She was extremely happy to see him.（她见到他非常高兴。）',
      ],
      synonyms: [
        { word: 'incredibly', note: '难以置信地，更强调惊讶' },
        { word: 'remarkably', note: '显著地，带有让人注目的意味' },
      ],
    },
    {
      word: 'reaching up',
      phonetic: '/ˈriːtʃɪŋ ʌp/',
      brief: '伸手去够，向上伸手',
      pos: 'phrasal verb (present participle)',
      detail:
        'reach up 指向上方伸手去够某物。原文中悟空注意到妖怪 reaching up his sleeve（把手伸进袖子里），描写了一个可疑的小动作。',
      examples: [
        'The child reached up to grab the cookie jar.（孩子伸手去够饼干罐。）',
        'She reached up to the top shelf.（她伸手去够最上面的架子。）',
      ],
      synonyms: [
        { word: 'stretching up', note: '向上伸展' },
      ],
    },
    {
      word: 'spun',
      phonetic: '/spʌn/',
      brief: '猛地转身，旋转',
      pos: 'verb (past tense of spin)',
      detail:
        'spin 的过去式 spun 指快速旋转或猛然转身。原文中妖怪 spun around（猛地转过身来），手中举着金属环。spun around 描写了一个突然的旋转动作，充满戏剧性。',
      examples: [
        'She spun around to face him.（她猛地转过身面对他。）',
        'The dancer spun gracefully.（舞者优雅地旋转。）',
      ],
      synonyms: [
        { word: 'whirled', note: '急转，速度更快' },
        { word: 'turned', note: '转身，更中性' },
      ],
    },
    {
      word: 'mentioned',
      phonetic: '/ˈmɛnʃənd/',
      brief: '提到，提及',
      pos: 'verb (past tense of mention)',
      detail:
        'mention 指简要地提到、提及某人或某事。原文中悟空回想起妖怪 also mentioned the Jade Emperor（还提到了玉皇大帝），从而推测妖怪可能来自天庭。',
      examples: [
        'He mentioned your name during the conversation.（他在谈话中提到了你的名字。）',
        'She didn\u2019t mention anything about the party.（她完全没提派对的事。）',
      ],
      synonyms: [
        { word: 'referred to', note: '提到、指的是，更正式' },
        { word: 'noted', note: '注意到，更强调留意到' },
      ],
    },
    {
      word: 'warrior',
      ...
      pos: 'noun',
      detail:
        'warrior 指勇猛的战士、武士。原文中玉皇大帝派了一个 warrior（武士）去捉拿独角犀牛。warrior 比 soldier 更强调个人的勇武和战斗能力。',
      examples: [
        'The warriors fought bravely in the battle.（武士们在战斗中英勇作战。）',
        'He was a great warrior in ancient times.（他是古代一位伟大的战士。）',
      ],
      synonyms: [
        { word: 'fighter', note: '战士，更口语化' },
        { word: 'soldier', note: '士兵，更强调军队编制' },
      ],
    },
    {
      word: 'banged',
      ...
      pos: 'verb (past tense of bang)',
      detail:
        'bang 指用力猛敲，发出巨大的声响。原文中武士 banged on the cave door（砰砰猛敲洞门），表现出了天庭来人的气势。bang 强调声响巨大。',
      examples: [
        'He banged on the door.（他砰砰地敲门。）',
        'She banged the drum loudly.（她大声地敲鼓。）',
      ],
      synonyms: [
        { word: 'pounded', note: '连续重击，力度更大' },
        { word: 'knocked', note: '敲门，更温和' },
      ],
    },
    {
      word: 'fell',
      phonetic: '/fɛl/',
      brief: '沉下来，（表情）垮掉',
      pos: 'verb (past tense of fall)',
      detail:
        'fall 有许多引申义。原文中 The warrior\u2019s face fell（武士的脸沉了下来），face fell 是固定搭配，形容脸上的表情从自信变成失望或沮丧。',
      examples: [
        'His face fell when he heard the news.（听到消息后他的脸沉了下来。）',
        'Her smile fell.（她的笑容消失了。）',
      ],
      synonyms: [
        { word: 'dropped', note: '落下，更中性' },
        { word: 'darkened', note: '表情阴沉下来' },
      ],
    },
    {
      word: 'flaming',
      ...
      pos: 'adjective',
      detail:
        'flaming 指正在燃烧的、冒着火焰的。原文中 fire god 手持 a large, flaming spear（一把燃烧的长矛），flaming 描写了武器上笼罩着火焰的状态。',
      examples: [
        'The flaming torch lit up the dark cave.（燃烧的火把照亮了黑暗的洞穴。）',
        'Flaming debris fell from the sky.（燃烧的碎片从天而降。）',
      ],
      synonyms: [
        { word: 'blazing', note: '熊熊燃烧的，火焰更旺' },
        { word: 'burning', note: '燃烧的，更通用' },
      ],
    },
    {
      word: 'spear',
      ...
      pos: 'noun',
      detail:
        'spear 指长矛，一种古代武器。原文中火神手持 fire spear（火焰长矛），是神话中的武器。spear 是最基本的长矛形状。',
      examples: [
        'The warrior threw his spear at the enemy.（武士向敌人投掷长矛。）',
        'Ancient soldiers fought with spears and shields.（古代士兵用长矛和盾牌战斗。）',
      ],
      synonyms: [
        { word: 'lance', note: '骑枪，骑兵用的长矛' },
        { word: 'pike', note: '长枪，步兵用的超长矛' },
      ],
    },
    {
      word: 'boomed',
      ...
      pos: 'verb (past tense of boom)',
      detail:
        'boom 指发出低沉、响亮的声音。原文中雷神 boomed（用雷鸣般的声音大喊），配合他作为雷神的身份。boom 常用来形容声音洪亮、有威慑力。',
      examples: [
        'He boomed, \u201cCome out!\u201d（他大声喊道：\u201c出来！\u201d）',
        'The thunder boomed overhead.（雷声在头顶轰鸣。）',
      ],
      synonyms: [
        { word: 'roared', note: '咆哮，更凶猛' },
        { word: 'bellowed', note: '大声吼叫，低沉有力' },
      ],
    },
    {
      word: 'hurled',
      ...
      pos: 'verb (past tense of hurl)',
      detail:
        'hurl 指用力猛投某物。原文中雷神 hurled his thunderbolt at the demon（向妖怪猛力投掷雷电），hurl 比 throw 强调力量大、速度快。',
      examples: [
        'He hurled the ball as far as he could.（他尽全力把球扔出去。）',
        'She hurled insults at him.（她对他破口大骂。\u2014\u2014比喻用法）',
      ],
      synonyms: [
        { word: 'flung', note: '用力甩出，更随意' },
        { word: 'launched', note: '发射、投射，更正式' },
      ],
    },
    {
      word: 'thunderbolt',
      phonetic: '/ˈθʌndərboʊlt/',
      brief: '雷电，雷霆',
      pos: 'noun',
      detail:
        'thunderbolt 指雷电、霹雳。在西方神话中，thunderbolt 是宙斯的武器；在中国神话中，雷电也是常见的法术武器。原文中雷神投掷 thunderbolt 攻击妖怪，却被金属环吸走了。',
      examples: [
        'Zeus threw a thunderbolt at his enemy.（宙斯向敌人投掷了一道雷电。）',
        'The news hit him like a thunderbolt.（这个消息如同晴天霹雳。）',
      ],
      synonyms: [
        { word: 'lightning bolt', note: '闪电，更偏自然现象' },
        { word: 'bolt', note: '霹雳，简称' },
      ],
    },
  ],
